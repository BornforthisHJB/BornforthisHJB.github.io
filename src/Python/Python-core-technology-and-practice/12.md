...
![img](./12.assets/976f82f257e4f86857fe0561316c82df.jpg)
...
![](./12.assets/image-20221008110128108.png)
...
这样一来，我们就简洁地实现了缓存，而且还是在不影响 `· 代码的情况下。这部分内容希望你多读几遍，`自己揣摩清楚，通过这个例子多多体会继承的优势。
