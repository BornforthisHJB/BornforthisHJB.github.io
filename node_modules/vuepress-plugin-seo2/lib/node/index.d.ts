...
declare type SeoContent = ArticleSeoContent | ExtendedSeoContent | FacebookSeoContent | TwitterSeoContent | SimpleSeoContent;

declare type ExtendPage<ExtraPageData extends Record<string | number | symbol, unknown> & {
    git?: GitData;
} = {
    git?: GitData;
...
export { ArticleJSONLD, ArticleSeoContent, BaseSeoContent, ExtendPage, ExtendedSeoContent, FacebookSeoContent, SeoContent, SeoOptions, SimpleSeoContent, TwitterSeoContent, seoPlugin as default, seoPlugin };
