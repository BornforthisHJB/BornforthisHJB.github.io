...
export default hopeTheme({
  ...
  // iconAssets: "iconfont",
  iconAssets: "//at.alicdn.com/t/c/font_3426793_rqf2e6b50v.css",
  ...
  encrypt: {
    config: {
      ...
      "/column/Python-practice/Answer/The-University-of-Melbourne/exam-2019s1-solution.html": "exam-2019s1-solution",
