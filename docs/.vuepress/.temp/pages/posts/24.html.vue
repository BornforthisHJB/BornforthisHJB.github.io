<template><div><p><img src="@source/posts/24.assets/78fbac2d48a43ac46f715621c5b082e4.png" alt="img" loading="lazy"></p>
<p>你好，我是悦创。</p>
...
<h2 id="_1-什么是二进制计数法" tabindex="-1"><a class="header-anchor" href="#_1-什么是二进制计数法" aria-hidden="true">#</a> 1. 什么是二进制计数法？</h2>
...
<p>让我们来观察一个数字：2871。</p>
<p><img src="@source/posts/24.assets/2571175abba350ca5b5a1bd6bc52ba13.png" alt="img" loading="lazy"></p>
<p>其中 ^ 表示幂或次方运算。十进制的数位（千位、百位、十位等）全部都是 10^n 的形式。需要特别注意的是，任何非 0 数字的 0 次方均为 1。在这个新的表示式里，10 被称为十进制计数法的基数，也是十进制中“十”的由来。这个我想你应该好理解，因为这和我们日常生活的习惯是统一的。</p>
...
<p><img src="@source/posts/24.assets/494dec6eb241cc121e6974aaf3d8b9f1.png" alt="img" loading="lazy"></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Lesson1_1</span> <span class="token punctuation">{</span>
    ...
    */</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，我们通过一个十进制数和一个二进制数，来验证一下上述代码的正确性。</p>
...
<h2 id="_2-计算机为什么使用二进制" tabindex="-1"><a class="header-anchor" href="#_2-计算机为什么使用二进制" aria-hidden="true">#</a> 2. 计算机为什么使用二进制？</h2>
<p>我觉得，计算机使用二进制和现代计算机系统的硬件实现有关。组成计算机系统的逻辑电路通常只有两个状态，即开关的接通与断开。</p>
<p>断开的状态我们用 “0” 来表示，接通的状态用 “1” 来表示。由于每位数据只有断开与接通两种状态，所以即便系统受到一定程度的干扰时，它仍然能够可靠地分辨出数字是 “0” 还是 “1” 。因此，在具体的系统实现中，<strong>二进制的数据表达具有抗干扰能力强、可靠性高的优点。</strong></p>
...
<h2 id="_3-二进制的位操作" tabindex="-1"><a class="header-anchor" href="#_3-二进制的位操作" aria-hidden="true">#</a> 3. 二进制的位操作</h2>
...
<h3 id="_1-向左移位" tabindex="-1"><a class="header-anchor" href="#_1-向左移位" aria-hidden="true">#</a> 1. 向左移位</h3>
<p>我们先来看向左移位。</p>
...
<p><img src="@source/posts/24.assets/226f99f7a1f60d92c21c7b26ab007396.png" alt="img" loading="lazy"></p>
<p>在这个例子中，如果将 1101010 换算为十进制，就是 106，你有没有发现，106 正好是 53 的 2 倍。所以，我们可以得出一个结论：<strong>二进制左移一位，其实就是将数字翻倍。</strong></p>
<blockquote>
<p>把二进制数进行展开，左移动一位，意味着分解的系数都增加了一位，相对于原来的二进制展开，全部乘2，也就是最终结果也乘2</p>
</blockquote>
<h3 id="_2-向右移位" tabindex="-1"><a class="header-anchor" href="#_2-向右移位" aria-hidden="true">#</a> 2. 向右移位</h3>
<p>接下来我们来看向右移位。</p>
...
<p><img src="@source/posts/24.assets/d3a81523157f1eaf4d7f469acd89e831.png" alt="img" loading="lazy"></p>
...
<p><strong>左移位是 &lt;&lt;，那右移位为什么是 &gt;&gt;&gt; 而不是 &gt;&gt; 呢？</strong></p>
<p>实际上，&gt;&gt; 也是右移操作。简单来说，之所以有这两种表达方式，根本原因是 Java 的二进制数值中最高一位是符号位。这里我给你详细解释一下。</p>
<p>当符号位为 0 时，表示该数值为正数；当符号位为 1 时，表示该数值为负数。我们以 32 位 Java 为例，数字 53 的二进制为 110101，从右往左数的第 32 位是 0，表示该数是正数，只是通常我们都将其省略。</p>
<p><img src="@source/posts/24.assets/fdd786692a45919ab1385f1f20f50542.png" alt="img" loading="lazy"></p>
<p>如果数字是 -53 呢？那么第 32 位就不是 0，而是 1。请注意我这里列出的是补码。</p>
<p><img src="@source/posts/24.assets/be2b8c8e40b50aef3884b19310677eaa.png" alt="img" loading="lazy"></p>
...
<p><img src="@source/posts/24.assets/4ee0df04bcd432f27178ffa68ccba68e.png" alt="img" loading="lazy"></p>
<p>算术右移时保持符号位不变，除符号位之外的右移一位并补符号位 1。补的 1 仍然在符号位之后。</p>
<p><img src="@source/posts/24.assets/7481e22da92e72c07d511e3aa09086b8.png" alt="img" loading="lazy"></p>
...
<h3 id="_3-位的-或" tabindex="-1"><a class="header-anchor" href="#_3-位的-或" aria-hidden="true">#</a> 3. 位的“或”</h3>
...
<p><img src="@source/posts/24.assets/c2d7d75f59650ada73d1115fb4434ce8.png" alt="img" loading="lazy"></p>
<h3 id="_4-位的-与" tabindex="-1"><a class="header-anchor" href="#_4-位的-与" aria-hidden="true">#</a> 4. 位的“与”</h3>
...
<p><img src="@source/posts/24.assets/015a48115b97e26fc9a7cd6dd0ce0f93.png" alt="img" loading="lazy"></p>
<h3 id="_5-位的-异或" tabindex="-1"><a class="header-anchor" href="#_5-位的-异或" aria-hidden="true">#</a> 5. 位的“异或”</h3>
...
<p><img src="@source/posts/24.assets/40a4b93869a81e728b58b1c1bdef76e6.png" alt="img" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码的运行结果是：数字 53(110101) 和数字 35(100011) 的按位‘或’结果是 55(110111)，数字 53(110101) 和数字 35(100011) 的按位‘与’结果是 33(100001)，数字 53(110101) 和数字 53(110101) 的按位‘异或’结果是 0(0)。</p>
<h2 id="_4-小结" tabindex="-1"><a class="header-anchor" href="#_4-小结" aria-hidden="true">#</a> 4. 小结</h2>
<p>今天我们聊了二进制，你可能会问：学习二进制究竟有什么用呢？平时的编程中，我们好像并没有使用相关的知识啊？确实，目前的高级语言可以帮助我们将人类的思维逻辑转换为使用 0 和 1 的机器语言，我们不用再为此操心了。但是，二进制作为现代计算机体系的基石，这些基础的概念和操作，你一定要非常了解。</p>
...
<p>如果不使用 Java 语言自带的 BigInteger 类，我们还有什么方法来实现十进制到二进制的转换呢？（提示：可以使用二进制的移位和按位逻辑操作来实现。）</p>
