<template><div><p>打开偏好设置，将冲突的快捷键关掉，就可以解决 idea 使用注释快捷键，会打开 help 页面的问题</p>
<p><img src="@source/posts/28.assets/image-20220708003522663.png" alt="image-20220708003522663" loading="lazy"></p>
<p><img src="@source/posts/28.assets/image-20220708003544264.png" alt="image-20220708003544264" loading="lazy"></p>
