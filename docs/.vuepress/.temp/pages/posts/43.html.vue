<template><div><h2 id="个人简介" tabindex="-1"><a class="header-anchor" href="#个人简介" aria-hidden="true">#</a> 个人简介</h2>
<p>大家好，我是翰慧腾。一名正在努力学JAVA的大一小白，本文章为初学的笔记，希望各位多多指教。💙</p>
<p>欢迎点赞+收藏+留言💜</p>
<p>生活不止眼前的苟且，还有诗和远方🧡</p>
<h2 id="一、内部类" tabindex="-1"><a class="header-anchor" href="#一、内部类" aria-hidden="true">#</a> 一、内部类</h2>
<p>内部类顾名思义就是在一个类内部声明另一个类，包含内部类的称为外部类。内部类一般用来实现一些没有通用意义的功能逻辑,可以访问外部类的成员，包括私有的成员。（TIP：外部类只可以用 public 默认修饰，但是内部类可以用 private protected 修饰，增强了其封装性。）</p>
<p>创建的内部类都会产生 class 文件。</p>
<h2 id="内部类分类" tabindex="-1"><a class="header-anchor" href="#内部类分类" aria-hidden="true">#</a> 内部类分类：</h2>
<ol>
<li>静态内部类（了解即可）</li>
</ol>
<p>静态内部类首先肯定要有static修饰，可以访问外部类的非静态变量、静态变量，不能访问外部类的非静态变量（需要实例化）。该类同之前学的类相同，只是在内部罢了，代码可以证明一切。如下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token constant">CSDN1</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Outter</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>静态内部类创建对象格式：</p>
<p><img src="@source/posts/43.assets/6ad984380fad40afab3c316e685248ac.png" alt="img" loading="lazy"></p>
<p>接上述代码：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token constant">CSDN1</span><span class="token punctuation">;</span>
...
<li>成员内部类： 无 static 修饰，属于外部类的对象（jdk16 之后开始支持内部类中定义静态成员变量、方法。在 jdk 之前是不支持的），相当于是外部类的对象，通过创建对象来调用。内部类中的实例方法可以直接访问外部类的实例成员、静态成员。创建对象格式：</li>
</ol>
<p><img src="@source/posts/43.assets/4ef97a93893641418818dee8604317a8.png" alt="img" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token constant">CSDN1</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此处附赠一道很有意思的面试题：</p>
<p><img src="@source/posts/43.assets/29fabd11eeb841e7b2aae87b23b6131c.png" alt="img" loading="lazy"></p>
<p>答案：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token class-name">Stickto</span><span class="token punctuation">;</span>
...
<li>局部内部类（了解即可）：很多人都会认为局部内部类就是函数内部定义的类。其实并不一定在方法内，只要在局部（非外部类的成员部分）都叫做是局部内部类。</li>
</ol>
<h2 id="二、匿名内部类-重点-开发中常用" tabindex="-1"><a class="header-anchor" href="#二、匿名内部类-重点-开发中常用" aria-hidden="true">#</a> 二、匿名内部类（重点，开发中常用）</h2>
<p>匿名内部类本质上就是没有类名、没有 class 修饰的局部内部类，定义在方法中、代码块中等。方便创建子类对象，简化代码的编写。
抽象类不能直接创建对象，需要重写抽样方法后才可以直接创建。</p>
<p>废话不多说，直接上代码</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token class-name">Stickto</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总而言之，匿名内部类就是针对之前不能对抽象类、接口创建对象的情况。当然，有了匿名内部类之后也不能创建接口、抽象类的对象，而是通过创建匿名内部类对象达到了不用写子类的效果。匿名内部类就是对其抽象方法进行了重写。</p>
