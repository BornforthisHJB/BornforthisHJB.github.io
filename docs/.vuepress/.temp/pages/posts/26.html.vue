<template><div><h2 id="java-中的「与运算-」-规则-都为-1-时才为-1-否则为-0" tabindex="-1"><a class="header-anchor" href="#java-中的「与运算-」-规则-都为-1-时才为-1-否则为-0" aria-hidden="true">#</a> Java 中的「与运算 &amp; 」 规则 ：都为 1 时才为 1，否则为 0</h2>
<ul>
<li>即：两位同时为 “1”，结果才为 “1”，否则为 0</li>
</ul>
<p>例如：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="java-中的「或运算-」-规则-有一个为-1-则为-1" tabindex="-1"><a class="header-anchor" href="#java-中的「或运算-」-规则-有一个为-1-则为-1" aria-hidden="true">#</a> Java 中的「或运算 | 」 规则 ：有一个为 1，则为 1</h2>
<ul>
<li>即 ：参加运算的两个对象只要有一个为 1，其值为 1。</li>
</ul>
<p>例如：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span> args<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">{</span>        
         ...
         * */</span>    
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="java-中的「异或运算-」-规则-都不同时-为-1" tabindex="-1"><a class="header-anchor" href="#java-中的「异或运算-」-规则-都不同时-为-1" aria-hidden="true">#</a> Java 中的「异或运算 ^ 」 规则 ：都不同时，为 1</h2>
<ul>
<li>即：参加运算的两个对象，如果两个相应位为“异”（值不同），则该位结果为 1，否则为 0。</li>
</ul>
<p>例如：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span> args<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span> <span class="token number">7</span> <span class="token operator">^</span> <span class="token number">9</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
         ...
         * */</span>
    <span class="token punctuation">}</span>    
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="java-中的「取反运算-」-规则-按位取反" tabindex="-1"><a class="header-anchor" href="#java-中的「取反运算-」-规则-按位取反" aria-hidden="true">#</a> Java 中的「取反运算 ~ 」 规则 ：按位取反</h2>
<ul>
<li>
<p>即：对一个二进制数按位取反，即将 1 变 0 ， 0 变 1。</p>
</li>
<li>
<p>按位取反运算符“~”的原理：是将内存中的补码按位取反（包括符号位）。</p>
<ol>
<li>二进制数在内存中是以补码的形式存放的。</li>
<li>补码首位是符号位，0 表示此数为正数，1 表示此数为负数。</li>
<li>正数的补码、反码，都是其本身。</li>
<li>负数的反码是：符号位为 1，其余各位求反，但末位不加 1 。</li>
<li>负数的补码是：符号位不变，其余各位求反，末位加 1 。</li>
<li>所有的取反操作、加 1、减 1 操作，都在有效位进行。</li>
</ol>
</li>
</ul>
<p><strong>例如：正数</strong></p>
<ul>
<li>正数 9（二进制为：1001）在内存中存储为 01001，必须补上符号位（开头的数字 0 为符号位）。</li>
<li>转二进制：0 1001</li>
<li>计算补码：0 1001「正数的补码也就是原码」</li>
<li>按位取反：1 0110 (变成补码，这明显变成了一个负数补码，因为符号位是 1)</li>
<li>补码减1 ：1 0101</li>
<li>再取反 ：1 1010</li>
<li>符号位为1是负数，即-10</li>
</ul>
<p><strong>例如：负数</strong></p>
<ul>
<li>负数 -1（二进制为：0001 ）在内存中存储为 10001，必须补上符号位（开头的数字 1 为符号位）。</li>
<li>-1 的反码为 11110</li>
<li>-1 的补码为 11111 （也可以理解为：反码末位加上1就是补码）</li>
<li><code v-pre>~-1</code> 的取反 00000</li>
<li><code v-pre>~-1</code> 结果为：0</li>
</ul>
<p>例 1：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">test2</span><span class="token punctuation">;</span>
