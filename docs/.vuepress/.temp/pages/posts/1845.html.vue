<template><div><p>你好，我是悦创。最近，手里有个单子，但是奈何自己实习公司事情太多。所以就把我一对一学员的项目，介绍给 Panda4u 。最后他遇到加密就头疼了。本文将会对这个系列的爬虫进行分析和抓取。仅供学习交流使用！ 近期爬取了私募排排网上的历史净值，写一下爬取过程中的一些心得体会。</p>
<p><img src="@source/posts/1845.assets/34bd0e5c23d596cdf2d37bc2f7b8dc82.png" alt="image-20210811093545176" loading="lazy"></p>
<p>原本，思考的时候觉得，selenium 是“万能的”，应该可以一力破万法，结果果然栽跟头了。 上面有很多的难点，例如直接利用 selenium 会被检测出反爬、爬取的数值被加密（页面上看到的和 html 中不一样，多了一些隐藏值)等等。爬取的方法主要就是 selenium、正则、beautifulsoup、xpath。这里先把这里使用的库导入。</p>
...
<h2 id="一、开启网页" tabindex="-1"><a class="header-anchor" href="#一、开启网页" aria-hidden="true">#</a> 一、开启网页</h2>
<p>有的网站直接使用 selenium 就可以开启，例如</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是在这里就会出现以下情况，那是因为如果直接开启网页，就会被发现是爬虫。</p>
<p><img src="@source/posts/1845.assets/d7a97a62b41457d50f2e5250978b99dc.png" alt="image-20210811110608372" loading="lazy"></p>
<p>解决这个问题要使用以下代码</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>driver <span class="token operator">=</span> webdriver<span class="token punctuation">.</span>Chrome<span class="token punctuation">(</span><span class="token punctuation">)</span>         <span class="token comment"># 启动驱动器</span>
...
driver<span class="token punctuation">.</span>get<span class="token punctuation">(</span><span class="token string">'https://www.simuwang.com/user/option'</span><span class="token punctuation">)</span>       <span class="token comment"># 加载网站</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后就能完美的开启网页了。</p>
<p><img src="@source/posts/1845.assets/55a97cb462991d7d001c50924252d591.png" alt="image-20210811111137124" loading="lazy"></p>
<p><strong>注意：</strong> 这里设置开发者模式也是不可行的！</p>
<h2 id="二、selenium-定位元素解析网页" tabindex="-1"><a class="header-anchor" href="#二、selenium-定位元素解析网页" aria-hidden="true">#</a> 二、selenium 定位元素解析网页</h2>
<p>在进入网页之后，就开始元素定位。selenium 定位一共有八个 <strong>name</strong> ， <strong>id</strong> ，<strong>link_text</strong> ，<strong>partial_link_text</strong> ，<strong>class_name</strong> ，<strong>xpath</strong>，<strong>css</strong>，<strong>tag_name</strong> 。其中最少也要掌握 <strong>xpath</strong> 或者 <strong>css</strong> 一种方法（使用这两种方法基本上能解决所有的定位）。后面，我会考虑出一个 Xpath 的提取视频教程，看大家的对于这篇文章的阅读量，如果过三百我就马上录。 详细用法，可以关注后续的文章，这里就不多赘述了。在这里就讲讲 selenium 这里的用法，我使用的方法是 xpath。</p>
<h3 id="_1-输入账号和输入密码点击登录" tabindex="-1"><a class="header-anchor" href="#_1-输入账号和输入密码点击登录" aria-hidden="true">#</a> 1. 输入账号和输入密码点击登录</h3>
<p><img src="@source/posts/1845.assets/62a5099148755727b483b00c3c8c818a.png" alt="" loading="lazy"></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>driver<span class="token punctuation">.</span>find_element<span class="token punctuation">(</span>By<span class="token punctuation">.</span>XPATH<span class="token punctuation">,</span><span class="token string">'//button[@class="comp-login-method comp-login-b2"]'</span><span class="token punctuation">)</span><span class="token punctuation">.</span>click<span class="token punctuation">(</span><span class="token punctuation">)</span>      <span class="token comment">#点击账号密码登录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>补充</strong>：</p>
<ol>
<li>
<p>以后使用定位最好都用 By（也就是以上的方法），而 <code v-pre>driver.find_element_by_xpath()</code>，因为后面的这种不利于封装。</p>
</li>
<li>
<p>元素定位是做什么的？我们为什么要定位元素？有什么用呢？</p>
<ol>
<li>元素定位就是在 html 中找到我们在网页中看到内容对应的元素。</li>
<li>找到之后可以使用鼠标事事件和键盘事件，对网页进行人工模拟操作。</li>
<li>在这里就是简单的键盘事件 <code v-pre>send_keys</code> 和鼠标事件 <code v-pre>click</code>。</li>
</ol>
</li>
</ol>
<h3 id="_2-叉掉广告-网页后退" tabindex="-1"><a class="header-anchor" href="#_2-叉掉广告-网页后退" aria-hidden="true">#</a> 2. 叉掉广告，网页后退</h3>
<p><img src="@source/posts/1845.assets/be341a884dc36129fad78f276a042cce.png" alt="叉掉广告，网页后退" loading="lazy"></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>time<span class="token punctuation">.</span>sleep<span class="token punctuation">(</span><span class="token number">15</span><span class="token punctuation">)</span>              <span class="token comment"># 等待登录时间</span>
...
<ol>
<li>
<p>注意这里必须要 sleep 几秒。那是因为登录过程需要时间加载，不然会报错。</p>
</li>
<li>
<p><code v-pre>driver.back()</code> 是将当前页面返回上一级。那么 <code v-pre>driver.forward()</code> 前进到上一级。</p>
</li>
</ol>
<h3 id="_3-鼠标悬停点击自选" tabindex="-1"><a class="header-anchor" href="#_3-鼠标悬停点击自选" aria-hidden="true">#</a> 3. 鼠标悬停点击自选</h3>
<p><img src="@source/posts/1845.assets/af9d8aa0601231bc3ab41c82100abbe5.png" alt="鼠标悬停点击自选" loading="lazy"></p>
<p>鼠标悬停在用户上，然后点击自选进入网页。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>time<span class="token punctuation">.</span>sleep<span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">)</span>       <span class="token comment"># 加载网页需要等待时间</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里的悬停操作就是定位用户然后使用 ActionChains 进行悬停，在悬停中找到自选并点击。</p>
<h3 id="_4-解析网页" tabindex="-1"><a class="header-anchor" href="#_4-解析网页" aria-hidden="true">#</a> 4. 解析网页</h3>
<p>经历以上的步骤就来到了我们需要爬取数据的页面了。我们需要的数据在每一个基金里面的历史净值。所以我们先要得到每一个基金的网址，然后进入网站里面进行处理。</p>
<p><img src="@source/posts/1845.assets/046ae0a1a1c4a23ce72c7b058bf28f47.png" alt="" loading="lazy"></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 解析网页</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里使用了 BeautifulSoup 对 page 进行解析，然后使用 select 定位找到每个基金的网址和基金名称。</p>
<h2 id="二、对每个基金处理" tabindex="-1"><a class="header-anchor" href="#二、对每个基金处理" aria-hidden="true">#</a> 二、对每个基金处理</h2>
<p>经过上一步解析网页之后，得到每个基金的网站。现在循环处理这些网址，爬取数据。</p>
<h3 id="_1-解析每个基金网页" tabindex="-1"><a class="header-anchor" href="#_1-解析每个基金网页" aria-hidden="true">#</a> 1. 解析每个基金网页</h3>
<p>解析每个基金网页还是运用 <code v-pre>driver.get</code> 加载网页，利用 <code v-pre>page_source</code> 解析网页。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>driver<span class="token punctuation">.</span>execute_cdp_cmd<span class="token punctuation">(</span><span class="token string">"Page.addScriptToEvaluateOnNewDocument"</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
    <span class="token string">"source"</span><span class="token punctuation">:</span> <span class="token triple-quoted-string string">"""
    Object.defineProperty(navigator, 'webdriver', {
      get: () => undefined
    })
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不过在 <code v-pre>page_source</code> 解析网页之前，有一个东西必须要注意！ 那就是如果直接解析网页得到的历史净值只有一小部分，是因为历史净值是一个动态的，我们在解析之前需要利用 selenium 将历史净值这个内嵌框下滑到底，而且这个内嵌框是一个异步加载的（滑动完后，又会出来一段），使用需要多个滑动才能满足条件。</p>
<p><img src="@source/posts/1845.assets/d50ad2e0d50440fc7519719fad98b117.png" alt="image-20210808164026623" loading="lazy"></p>
<p>解决问题要点：首先得将历史净值点击，然后定位历史净值框。</p>
<p><img src="@source/posts/1845.assets/d80effe581a6b000570adcb9cdb4eee9.png" alt="" loading="lazy"></p>
<p>如图已经定位到了内嵌框，下面就开滑动</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>driver<span class="token punctuation">.</span>find_element<span class="token punctuation">(</span>By<span class="token punctuation">.</span>XPATH<span class="token punctuation">,</span><span class="token string">'//div/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/a[2]'</span><span class="token punctuation">)</span><span class="token punctuation">.</span>click<span class="token punctuation">(</span><span class="token punctuation">)</span>        <span class="token comment"># 点击历史净值</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义一个函数，调用 xpath 解析的 page_source，返回值为隐藏值的属性值。即类似于 m440e0，m41fd7 的值。 然后只需要将隐藏值对应的元素找出来就行了。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>htmlEtree <span class="token operator">=</span> etree<span class="token punctuation">.</span>HTML<span class="token punctuation">(</span>text<span class="token operator">=</span>htmlData<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="三、将所有数据写入excel" tabindex="-1"><a class="header-anchor" href="#三、将所有数据写入excel" aria-hidden="true">#</a> 三、将所有数据写入excel</h3>
<p>最后再将净值日期和净值变动找到（这两个没有掺杂隐藏值，很简单就能找到），然后利用pandas写入excel中。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>write <span class="token operator">=</span> pandas<span class="token punctuation">.</span>ExcelWriter<span class="token punctuation">(</span><span class="token string">r"C:\Users\86178\Desktop\私募排排网历史净值爬取.xlsx"</span><span class="token punctuation">)</span>   <span class="token comment"># 新建xlsx文件。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后得到结果</p>
<p><img src="@source/posts/1845.assets/935340461449c7d4a226849b0cc56ff9.png" alt="" loading="lazy"></p>
<h3 id="四、总结" tabindex="-1"><a class="header-anchor" href="#四、总结" aria-hidden="true">#</a> 四、总结</h3>
<p>本文主要是讲的selenium的一些基本操作，例如鼠标事件、键盘事件和鼠标悬停。然后就是解密隐藏值。 我在这里遇见了很多的坑，思考了一个下午才把思路想到。我很庆幸在我最艰难的时候，没有说放弃，其实这次更大的收获是让自己对爬虫有更加深刻的见解。</p>
