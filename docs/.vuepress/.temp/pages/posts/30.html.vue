<template><div><p>Shadowrocket 是 iOS 平台相对稳定且更新多年的 App, 支持协议众多。</p>
<p>跟我购买的，我会发配置或者配置二维码。</p>
<p><img src="@source/posts/30.assets/Snipaste_2022-04-24_10-36-38.jpg" alt="img" loading="lazy"></p>
