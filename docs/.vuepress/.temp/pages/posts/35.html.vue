<template><div><p>Tkinter doesn't work, it throws an error.</p>
<h1 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h1>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token operator">%</span> pip3 install tk
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="my-code" tabindex="-1"><a class="header-anchor" href="#my-code" aria-hidden="true">#</a> My code</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="the-error" tabindex="-1"><a class="header-anchor" href="#the-error" aria-hidden="true">#</a> The Error</h1>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>Traceback <span class="token punctuation">(</span>most recent call last<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>or Python3 tkinter can be simply installed by,</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>brew install python<span class="token operator">-</span>tk
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>pip sometimes wont work successfully on my Mac, especially with the High Sierra OS version. Brew can be used to install all kinds of software packages in mac.</p>
