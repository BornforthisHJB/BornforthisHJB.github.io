<template><div><h1 id="_01-java-环境测试" tabindex="-1"><a class="header-anchor" href="#_01-java-环境测试" aria-hidden="true">#</a> 01-Java 环境测试</h1>
<h2 id="_1-命令行检测-java-是否安装成功" tabindex="-1"><a class="header-anchor" href="#_1-命令行检测-java-是否安装成功" aria-hidden="true">#</a> 1. 命令行检测 Java 是否安装成功</h2>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> java
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>检测 Java 版本：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> java <span class="token operator">--</span>version
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="检测-javac-version" tabindex="-1"><a class="header-anchor" href="#检测-javac-version" aria-hidden="true">#</a> 检测 <code v-pre>javac --version</code>：</h2>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> javac <span class="token operator">--</span>version
javac <span class="token number">14.0</span><span class="token number">.1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="你好javall" tabindex="-1"><a class="header-anchor" href="#你好javall" aria-hidden="true">#</a> 你好JAVAll</h2>
<h2 id="你好-java" tabindex="-1"><a class="header-anchor" href="#你好-java" aria-hidden="true">#</a> 你好 Java</h2>
<h2 id="java-代码编译运行" tabindex="-1"><a class="header-anchor" href="#java-代码编译运行" aria-hidden="true">#</a> Java 代码编译运行</h2>
<ol start="0">
<li>新建 java 代码：</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">QuickSand</span><span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>javac <span class="token class-name">QuickSand</span><span class="token punctuation">.</span>java
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<ol>
<li>如果运行之后没有任何输出，表面代码编写正确</li>
<li>如果代码写错则报错</li>
</ol>
</blockquote>
<p>Java 编译是检测 java 语法是否错误，区别于 Python 是边编译边运行。如果 Java 编译未报错，则会在当前 java 文件路径下，生成 QuickSand.class。</p>
<p>运行 Java ：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>java <span class="token class-name">QuickSand</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="tips" tabindex="-1"><a class="header-anchor" href="#tips" aria-hidden="true">#</a> Tips:</h2>
<p>Windows 命令行命令：dir:查看当前路径下的文件&amp;文件夹</p>
<p>Mac:ls:xxxxxx</p>
