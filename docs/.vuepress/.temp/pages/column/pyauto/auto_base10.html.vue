<template><div><h2 id="链接和查询代码" tabindex="-1"><a class="header-anchor" href="#链接和查询代码" aria-hidden="true">#</a> 链接和查询代码</h2>
<p>Python 自身携带 sqlite 库，不需要额外安装，直接使用即可。导入代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> sqlite3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>导入代码之后，将 <code v-pre>first.db</code> 文件，放到代码文件旁边。这里用的是 py，所以是把 py 和 <code v-pre>first.db</code> 文件放一起，不放一起就只能使用绝对路径。如下图：</p>
<p><img src="@source/column/pyauto/auto_base10.assets/image-20220717143802293.png" alt="image-20220717143802293" loading="lazy"></p>
<p>然后使用 sqlite3 库，链接 <code v-pre>first.db</code> 文件，代码 <code v-pre>firstdb = sqlite3.connect('first.db')</code></p>
<p>正常运行后，写查询语句，从数据库中读取全部数据，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 查询语句</span>
...
<p><img src="@source/column/pyauto/auto_base10.assets/image-20220717144442354.png" alt="image-20220717144442354" loading="lazy"></p>
<p>这是最简单的查询语句。数据库都是支持查询、删除、增加、更新操作的。</p>
<h2 id="删除数据操作" tabindex="-1"><a class="header-anchor" href="#删除数据操作" aria-hidden="true">#</a> 删除数据操作</h2>
<p>删除操作，将数据从数据库中移除，关键词 delete，先删除一条数据，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 删除特定数据</span>
...
<p><img src="@source/column/pyauto/auto_base10.assets/image-20220717150958014.png" alt="image-20220717150958014" loading="lazy"></p>
<h2 id="插入更多数据" tabindex="-1"><a class="header-anchor" href="#插入更多数据" aria-hidden="true">#</a> 插入更多数据</h2>
<p>增加的操作，关键词 add，使用 for 循环，先批量的增加一些数据：</p>
...
<span class="token keyword">for</span> result <span class="token keyword">in</span> firstdb<span class="token punctuation">.</span>execute<span class="token punctuation">(</span>query_sql<span class="token punctuation">)</span><span class="token punctuation">:</span>
    <span class="token keyword">print</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>for 循环，从 10 循环到 20，不含 20，然后全部执行 sql 语句和提交到数据库。最后查询全部数据，看下有没有增多，如下结果图：</p>
<p><img src="@source/column/pyauto/auto_base10.assets/image-20220717152956276.png" alt="image-20220717152956276" loading="lazy"></p>
<h2 id="更新数据操作" tabindex="-1"><a class="header-anchor" href="#更新数据操作" aria-hidden="true">#</a> 更新数据操作</h2>
<p>数据有增加，最后更新数据，关键词 update，做个条件更新，id 大于等于 4 的数据，设置 author 为“不匿名”，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 更新数据</span>
...
<span class="token keyword">for</span> result <span class="token keyword">in</span> firstdb<span class="token punctuation">.</span>execute<span class="token punctuation">(</span>query_sql<span class="token punctuation">)</span><span class="token punctuation">:</span>
    <span class="token keyword">print</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后的结果图如下：</p>
<p><img src="@source/column/pyauto/auto_base10.assets/image-20220717154945628.png" alt="image-20220717154945628" loading="lazy"></p>
<p>以上就是 Python 操作 sqlite 的全部代码了。</p>
<p><strong>【多选题】小练习</strong></p>
<p>数据库支持哪些操作？</p>
<ul class="task-list-container">
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-0"> 查询数据</label></li>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-1" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-1"> 新增数据</label></li>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-2" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-2"> 更新数据</label></li>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-3" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-3"> 删除数据</label></li>
</ul>
<blockquote>
<p>该数据库是单数据库操作，不要打开多个，这样有可能会锁死。</p>
</blockquote>
