<template><div><h2 id="xlutils-库的安装" tabindex="-1"><a class="header-anchor" href="#xlutils-库的安装" aria-hidden="true">#</a> xlutils 库的安装</h2>
<p>你好，我是悦创。</p>
<h3 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h3>
<p>往“<strong>虚假用户数据.xls</strong>”里面，追加额外的 50 条用户数据，就是<strong>标题+数据</strong>，达到 150 条。</p>
<h3 id="思路" tabindex="-1"><a class="header-anchor" href="#思路" aria-hidden="true">#</a> 思路</h3>
<ul>
<li>xlrd 是读取 Excel 文件的库</li>
<li>xlwt 是写入 Excel 的库</li>
</ul>
<p>如果使用以上两个库，可以一边读取，一边写入新文件。</p>
<p>不过在此，有另一个方便使用的库，库名是 xlutils，安装命令：<code v-pre>pip install xlutils</code>。</p>
<div class="language-cmd ext-cmd line-numbers-mode"><pre v-pre class="language-cmd"><code>pip install xlutils
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>安装好之后，开始写代码，完成追加 50 条数据的需求。</p>
<h2 id="书写代码" tabindex="-1"><a class="header-anchor" href="#书写代码" aria-hidden="true">#</a> 书写代码</h2>
<ol>
<li>导入所需的库，分别是 xlrd 和 xlutils</li>
</ol>
...
<li>使用 xlrd 打开文件，然后 xlutils 赋值打开后的 workbook，如下代码：</li>
</ol>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>wb <span class="token operator">=</span> xlrd<span class="token punctuation">.</span>open_workbook<span class="token punctuation">(</span><span class="token string">'虚假用户数据.xls'</span><span class="token punctuation">,</span> formatting_info<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">)</span>
xwb <span class="token operator">=</span> copy<span class="token punctuation">(</span>wb<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>wb 对象是 workbook，xwb 也是 workbook，但是后者可以写操作，前者不可以。</p>
<ol start="3">
<li>有了 workbook 之后，就开始指定 sheet，并获取这个 sheet 的总行数。</li>
</ol>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>sheet <span class="token operator">=</span> xwb<span class="token punctuation">.</span>get_sheet<span class="token punctuation">(</span><span class="token string">'第一个sheet'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>指定名称为“<strong>第一个sheet</strong>”的 sheet，然后获取全部的行，并输出总量，就得到了 sheet 中有 100 行。</p>
<ol start="4">
<li>有了具体的行数，然后保证原有数据不变动的情况下，从第 101 行写数据。101 行的索引是 100，索引循环的起始数值是 100。</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>range 函数，从 <code v-pre>len(rows)</code> 开始，到 <code v-pre>150-1</code> 结束，共 50 条。 faker 库是制造虚假数据的，这个在前面写数据有用过，循环写入了 50条。</p>
<ol start="5">
<li>最后保存就可以了</li>
</ol>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>xwb<span class="token punctuation">.</span>save<span class="token punctuation">(</span><span class="token string">'虚假用户数据.xls'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用 xwb，也就是操作之后的 workbook 对象，直接保存原来的文件名就可以了。</p>
<h2 id="office-办公软件查看数据结果" tabindex="-1"><a class="header-anchor" href="#office-办公软件查看数据结果" aria-hidden="true">#</a> Office 办公软件查看数据结果</h2>
<p>最后使用 Excel 软件打开这个 xls 文件，查看数据有多少行，如下代码：</p>
<p><img src="@source/column/pyauto/auto_base06.assets/image-20220712135438520.png" alt="image-20220712135438520" loading="lazy"></p>
<p>总共 150 行，原有数据 100 行，加上新写入的 50 行，数据没问题。</p>
<p>将以上的代码，合并起来多次运行，“<strong>虚假用户数据.xls</strong>” 的数据量会逐步增加，运行一次增加 50 行。</p>
<p>xlutils 是 <code v-pre>xlrd+xlwt</code> 的操作合集，但又不等于他们相加。库不一样，完成的操作不一样，所需的场景也不同，不同的需求用不同的库。</p>
