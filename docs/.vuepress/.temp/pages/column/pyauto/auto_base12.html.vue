<template><div><h2 id="需求说明" tabindex="-1"><a class="header-anchor" href="#需求说明" aria-hidden="true">#</a> 需求说明</h2>
<p>你好，我是悦创。</p>
<p>xlsxwriter 只能创建新的文件，不能对文件进行数据的追加和读取操作。</p>
<p>需要追加和读取 xlsx 文件，就需要用到 openpyxl 这个库了。安装命令：<code v-pre>pip install openpyxl</code>。</p>
<div class="language-cmd ext-cmd line-numbers-mode"><pre v-pre class="language-cmd"><code>pip install openpyxl
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用 openpyxl 完成这面这个需求：</p>
<ul>
<li>读取上面创建好的 <code v-pre>xlsxwriter插入数据和折线图.xlsx</code> 文件，复制一份，保存到 poenpyxl 插入数据和折线图[copy xlsxwriter].xlsx复制的文件中</li>
<li>sheet1 保持和源文件的 sheet1 一致，折线图不画复制的文件中</li>
<li>创建一个 sheet2，sheet2 的数据从 sheet1 中拷贝过来</li>
<li>随机的增加 1 年的随机数据，也就是 2020 年 1 月至 12 月的日期，数据1和数据2的12个数据随机生成</li>
<li>在sheet2中画一个折线图，统计数据1和数据2</li>
</ul>
<p>需求有四个，有难有易。</p>
<h2 id="拷贝文件" tabindex="-1"><a class="header-anchor" href="#拷贝文件" aria-hidden="true">#</a> 拷贝文件</h2>
<h3 id="第一个是拷贝文件和-sheet1" tabindex="-1"><a class="header-anchor" href="#第一个是拷贝文件和-sheet1" aria-hidden="true">#</a> 第一个是拷贝文件和 sheet1</h3>
<p>其实拷贝了文件，自然就包含 sheet1，最简单了，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> openpyxl
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样就得到了源文件和 sheet1 的复制品。</p>
<h2 id="拷贝-sheet-内容" tabindex="-1"><a class="header-anchor" href="#拷贝-sheet-内容" aria-hidden="true">#</a> 拷贝 sheet 内容</h2>
<h3 id="第二个需求-拷贝-sheet1-做成-sheet2" tabindex="-1"><a class="header-anchor" href="#第二个需求-拷贝-sheet1-做成-sheet2" aria-hidden="true">#</a> 第二个需求，拷贝 sheet1，做成 sheet2</h3>
<p>也简单，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> openpyxl
filename <span class="token operator">=</span> <span class="token string">'xlsxwriter插入数据和折线图.xlsx'</span>
wb <span class="token operator">=</span> openpyxl<span class="token punctuation">.</span>load_workbook<span class="token punctuation">(</span>filename<span class="token punctuation">)</span>
...
wb<span class="token punctuation">.</span>save<span class="token punctuation">(</span><span class="token string">'poenpyxl插入数据和折线图[copy xlsxwriter].xlsx'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>获取 sheet1，复制一个给 sheet2 参数，然后改下 sheet2 的标题 title，这个 title 就是文件的 sheet2 的名字。</p>
<h2 id="追加数据内容" tabindex="-1"><a class="header-anchor" href="#追加数据内容" aria-hidden="true">#</a> 追加数据内容</h2>
<h2 id="第三个需求-sheet2-中-数据1-和数据2-追加一年的数据-数据可以随意生成" tabindex="-1"><a class="header-anchor" href="#第三个需求-sheet2-中-数据1-和数据2-追加一年的数据-数据可以随意生成" aria-hidden="true">#</a> 第三个需求，sheet2 中，数据1 和数据2 追加一年的数据，数据可以随意生成</h2>
<p>貌似简单，但是年份时间不好计算，并且现在只有 2019 年的。如果之前数据是 2018 年，则追加一年，应该是 2019 年，所以要读取时间和月份追加。</p>
<p>这里的难点就是时间字符串的读取，以及字符串转时间，以及时间的相加。</p>
<p>如下实现代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> openpyxl<span class="token punctuation">,</span> random<span class="token punctuation">,</span> datetime
...
<li>一年 12 个月，循环 12 次，每次增加一个月，数值可以随机的生成，用 random 即可</li>
<li>数据的追加，是按每行，所以将【时间， 数据1， 数据2】通过 append 直接追加到数据最后即可</li>
</ul>
<p>第三个需求搞定，下一个需求，sheet2 画折线图</p>
<h2 id="使用-openpyxl-画图表" tabindex="-1"><a class="header-anchor" href="#使用-openpyxl-画图表" aria-hidden="true">#</a> 使用 openpyxl 画图表</h2>
<h3 id="第四个需求-在-sheet2-中对全部数据画折线图" tabindex="-1"><a class="header-anchor" href="#第四个需求-在-sheet2-中对全部数据画折线图" aria-hidden="true">#</a> 第四个需求，在 sheet2 中对全部数据画折线图</h3>
<p>这个难度不大，只要知道 openpyxl 的画图工具即可，如下代码：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> openpyxl<span class="token punctuation">,</span> random<span class="token punctuation">,</span> datetime
<span class="token keyword">from</span> dateutil<span class="token punctuation">.</span>relativedelta <span class="token keyword">import</span> relativedelta
filename <span class="token operator">=</span> <span class="token string">'xlsxwriter插入数据和折线图.xlsx'</span>
wb <span class="token operator">=</span> openpyxl<span class="token punctuation">.</span>load_workbook<span class="token punctuation">(</span>filename<span class="token punctuation">)</span>
...
wb<span class="token punctuation">.</span>save<span class="token punctuation">(</span><span class="token string">'poenpyxl插入数据和折线图[copy xlsxwriter].xlsx'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>导入所需的画图工具，图表初始化，然后生成数据对象：</p>
<ul>
<li>data1 的生成，因为索引从1开始，所以标题是第一行第二列，数据是第二行第二列，一直到最后一行第二列</li>
<li>data2 的生成，因为索引从1开始，所以标题是第一行第三列，数据是第二行第三列，一直到第二行最后三列</li>
<li>将两个数据都放到图表内</li>
<li>然后图表的开始位置，设置成 E3，数据在 ABC，E 是空的，3 距离顶部有两格的位置</li>
</ul>
<p>最后文件保存，大功告成。</p>
<h2 id="查看最后的效果图" tabindex="-1"><a class="header-anchor" href="#查看最后的效果图" aria-hidden="true">#</a> 查看最后的效果图</h2>
<p>然后就是用 Office 打开 poenpyxl 插入数据和折线图[copy xlsxwriter].xlsx，看下 sheet2 的样子，如下图：</p>
<p><img src="@source/column/pyauto/auto_base12.assets/201912101035209680.png" alt="3" loading="lazy"></p>
<p>25 行数据，除了标题 24 行，刚好是 2019+2020 的 24 个月。折线图也一切正常。</p>
