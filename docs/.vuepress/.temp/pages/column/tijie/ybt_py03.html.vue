...
<p>某商店笔记本有促销活动，规定购买 6 本以上（含 6 本）10 本以下（含 10 本）打九折，购买 11 本以上（含 11 本）打八折。给定笔记本单价和购买数量，请问购买总费用。</p>
<h3 id="【输入】" tabindex="-1"><a class="header-anchor" href="#【输入】" aria-hidden="true">#</a> 【输入】</h3>
<p>第一行一个整数 s，表示购买 s 本笔记本。</p>
<p>第二行一个实数 p，表示笔记本单价是 p。</p>
<h3 id="【输出】" tabindex="-1"><a class="header-anchor" href="#【输出】" aria-hidden="true">#</a> 【输出】</h3>
<p>输出一行，表示总费用。保留小数点后一位。</p>
<h3 id="【输入样例】" tabindex="-1"><a class="header-anchor" href="#【输入样例】" aria-hidden="true">#</a> 【输入样例】</h3>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token number">100</span> <span class="token number">3.2</span>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token number">256.0</span>
