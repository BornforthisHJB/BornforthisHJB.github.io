...
<ul>
<li>使用 <a href="https://docs.python.org/zh-cn/3/tutorial/inputoutput.html#tut-f-strings" target="_blank" rel="noopener noreferrer">格式化字符串字面值<ExternalLinkIcon/></a> ，要在字符串开头的引号/三引号前添加 <code v-pre>f</code> 或 <code v-pre>F</code> 。在这种字符串中，可以在 <code v-pre>{</code> 和 <code v-pre>}</code> 字符之间输入引用的变量，或字面值的 Python 表达式。</li>
</ul>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">56</span><span class="token punctuation">]</span><span class="token punctuation">:</span> year <span class="token operator">=</span> <span class="token number">2016</span>
...
<li>字符串的 <a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#str.format" target="_blank" rel="noopener noreferrer"><code v-pre>str.format()</code><ExternalLinkIcon/></a> 方法需要更多手动操作。该方法也用 <code v-pre>{</code> 和 <code v-pre>}</code> 标记替换变量的位置，虽然这种方法支持详细的格式化指令，但需要提供格式化信息。</li>
</ul>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">62</span><span class="token punctuation">]</span><span class="token punctuation">:</span> yes_votes <span class="token operator">=</span> <span class="token number">42_572_654</span>
...
<p>如果不需要花哨的输出，只想快速显示变量进行调试，可以用 <a href="https://docs.python.org/zh-cn/3/library/functions.html#repr" target="_blank" rel="noopener noreferrer"><code v-pre>repr()</code><ExternalLinkIcon/></a> 或 <a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#str" target="_blank" rel="noopener noreferrer"><code v-pre>str()</code><ExternalLinkIcon/></a> 函数把值转化为字符串。</p>
<p><a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#str" target="_blank" rel="noopener noreferrer"><code v-pre>str()</code><ExternalLinkIcon/></a> 函数返回供人阅读的值，<a href="https://docs.python.org/zh-cn/3/library/functions.html#repr" target="_blank" rel="noopener noreferrer"><code v-pre>repr()</code><ExternalLinkIcon/></a> 则生成适于解释器读取的值（如果没有等效的语法，则强制执行 <a href="https://docs.python.org/zh-cn/3/library/exceptions.html#SyntaxError" target="_blank" rel="noopener noreferrer"><code v-pre>SyntaxError</code><ExternalLinkIcon/></a>）。对于没有支持供人阅读展示结果的对象， <a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#str" target="_blank" rel="noopener noreferrer"><code v-pre>str()</code><ExternalLinkIcon/></a> 返回与 <a href="https://docs.python.org/zh-cn/3/library/functions.html#repr" target="_blank" rel="noopener noreferrer"><code v-pre>repr()</code><ExternalLinkIcon/></a> 相同的值。一般情况下，数字、列表或字典等结构的值，使用这两个函数输出的表现形式是一样的。字符串有两种不同的表现形式。</p>
<p>示例如下：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">79</span><span class="token punctuation">]</span><span class="token punctuation">:</span> x <span class="token operator">=</span> <span class="token number">10</span> <span class="token operator">*</span> <span class="token number">3.25</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="https://docs.python.org/zh-cn/3/library/string.html#module-string" target="_blank" rel="noopener noreferrer"><code v-pre>string</code><ExternalLinkIcon/></a> 模块包含 <a href="https://docs.python.org/zh-cn/3/library/string.html#string.Template" target="_blank" rel="noopener noreferrer"><code v-pre>Template</code><ExternalLinkIcon/></a> 类，提供了将值替换为字符串的另一种方法。该类使用 <code v-pre>$x</code> 占位符，并用字典的值进行替换，但对格式控制的支持比较有限。</p>
<h2 id="_7-1-1-格式化字符串字面值" tabindex="-1"><a class="header-anchor" href="#_7-1-1-格式化字符串字面值" aria-hidden="true">#</a> 7.1.1. 格式化字符串字面值</h2>
<p><a href="https://docs.python.org/zh-cn/3/reference/lexical_analysis.html#f-strings" target="_blank" rel="noopener noreferrer">格式化字符串字面值<ExternalLinkIcon/></a> （简称为 f-字符串）在字符串前加前缀 <code v-pre>f</code> 或 <code v-pre>F</code>，通过 <code v-pre>{expression}</code> 表达式，把 Python 表达式的值添加到字符串内。</p>
<p>格式说明符是可选的，写在表达式后面，可以更好地控制格式化值的方式。下例将 pi 舍入到小数点后三位：</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">42</span><span class="token punctuation">]</span><span class="token punctuation">:</span> <span class="token keyword">import</span> math
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <code v-pre>':'</code> 后传递整数，为该字段设置最小字符宽度，常用于列对齐：</p>
