...
<div class="custom-container tip">
<p class="custom-container-title">答案解析</p>
<p>正确答案：[2, 3] 列表的 pop 操作格式为 <code v-pre>列表名.pop(删除位置)</code> ，题中即为删除下标为 0 的元素.</p>
</div>
<ol start="4">
...
<p class="custom-container-title">答案解析</p>
<p>正确答案：[1, 4, 2, 3]</p>
<p>列表的 insert 操作格式为 <code v-pre>列表名.insert(插入位置，插入值)</code> ，题中即为在下标为 1 的位置插入 4.</p>
</div>
<ol start="5">
...
<ol start="6">
<li>
<p>列表对象的 <code v-pre>append()</code> 方法属于原地操作，用于在列表尾部追加一个元素。</p>
<p>A. √</p>
<p>B. X</p>
</li>
</ol>
...
<p class="custom-container-title">答案解析</p>
<p>正确答案：A 你的选择：A</p>
<p>易错项：B 记忆性知识点，如果需要复制一个新的对象，可以用 <code v-pre>y = x[:]</code></p>
</div>
<ol start="9">
<li>
<p>已知 x 是个列表对象，那么执行语句 <code v-pre>y = x[:]</code> 之后，对y所做的任何操作都会同样作用到x上。</p>
<p>A. √</p>
<p>B. X</p>
</li>
</ol>
...
<p class="custom-container-title">答案解析</p>
<p>正确答案：B</p>
<p>易错项：A <code v-pre>y=[:]</code> 是复制操作，y 和 x 的内存地址不一样，对 y 的修改不会影响到 x。</p>
</div>
<ol start="10">
<li>
<p>列表、元组、字符串支持双向索引。</p>
