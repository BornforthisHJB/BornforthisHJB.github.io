<template><div><ol>
<li>此题无需在线作答，请在纸上作答后查看答案解析 while 循环，只要 while 后面的条件为_____时才能不断循环，条件不满足时退出循环。</li>
</ol>
<div class="custom-container tip">
<p class="custom-container-title">答案解析</p>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>k <span class="token operator">=</span> <span class="token number">1000</span>
<span class="token keyword">while</span> k <span class="token operator">></span><span class="token number">1</span><span class="token punctuation">:</span>
    k <span class="token operator">=</span> k<span class="token operator">/</span><span class="token number">2</span>

<span class="token keyword">print</span><span class="token punctuation">(</span>k<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>A. 10 1.953</p>
<p>B. 10 0.9765625</p>
<p>C. 11 0.9765625</p>
<p>D. 11 1.953</p>
</li>
...
<p>最后一次执行完循环，k 已小于 1，,即不满足循环条件，跳出循环。输出数值为最后一次执行 <code v-pre>k=k/2</code> 之后的k值，即 <code v-pre>k=0.9765625</code> 。</p>
</div>
<ol start="4">
<li>
<p>有代码如下，请判断最后一个输出的数字是_____。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>n <span class="token operator">=</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>A. 100</p>
<p>B. 10</p>
<p>C. 11</p>
<p>D. 99</p>
</li>
...
<p class="custom-container-title">答案解析</p>
<p>正确答案：B</p>
<p>易错项：C while 循环条件是在 <code v-pre>1-100</code> 之内进行循环，并在大于 10 时在 break 处跳出整个循环，即当 <code v-pre>n=1</code> 1时满足跳出整个循环的条件，即停止循环。</p>
</div>
<ol start="5">
<li>
<p>用 Python 编程，假设一年期定期利率为 <code v-pre>3.25%</code> ，计算一下需要过多少年，一万元的一年定期存款连本带息能翻番？</p>
