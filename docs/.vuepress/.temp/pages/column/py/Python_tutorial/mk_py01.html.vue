<template><div><p><img src="@source/column/py/Python_tutorial/mk_py01.assets/5d56552a00010d2006400359.jpg" alt="img" loading="lazy"></p>
<blockquote>
<p>今天应做的事没有做，明天再早也是耽误了。——裴斯泰洛齐</p>
</blockquote>
<p>你好，我是悦创。Python/Java/C++资深工程师，曾深入使用多种程序语言，希望这个专栏在帮助读者顺利掌握 Python 的同时，也能让读者领悟学习任何一门语言的高效方法。</p>
...
<h2 id="python-是不是一个好选择" tabindex="-1"><a class="header-anchor" href="#python-是不是一个好选择" aria-hidden="true">#</a> Python 是不是一个好选择</h2>
...
<h2 id="python未来潜力如何" tabindex="-1"><a class="header-anchor" href="#python未来潜力如何" aria-hidden="true">#</a> Python未来潜力如何</h2>
...
<h2 id="python-2-or-python-3" tabindex="-1"><a class="header-anchor" href="#python-2-or-python-3" aria-hidden="true">#</a> Python 2 or Python 3</h2>
<p>在过去的很长一段时间中，学习 Python 的人常常在 Python 2 和 Python 3 版本间陷入选择困难。因为这两个版本存在着较大的不兼容，而 Python 2 由于历史更加悠久所以积累的第三方库要比 Python 3 多很多，同时由于将代码由 Python 2 迁移到 Python 3 不是一件容易的事，所以在 Python 3 发布后几年时间⾥，大家并没有太大动力使用这个新的版本，直接导致 Python 2 和 Python 3 在过去几年间割裂得十分严重。</p>
<p>但是时间已经来到了了 2019 年，大量的代码从 Python 2 版本迁移到了 Python 3，Python 官方也将在2020 年停止维护 Python 2 版本。所以 Python 2 和 Python 3 的选择已不再是个问题，读者朋友也不必再纠结怎么选择，请直接选 Python 3 吧，本专栏也将使用 Python 3 作为教学版本。</p>
<h2 id="开始-python-之旅" tabindex="-1"><a class="header-anchor" href="#开始-python-之旅" aria-hidden="true">#</a> 开始 Python 之旅</h2>
