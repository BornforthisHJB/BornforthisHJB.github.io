<template><div><p><img src="@source/column/py/Python_tutorial/mk_py02.assets/5d5655d400014c7c06400359.jpg" alt="img" loading="lazy"></p>
<blockquote>
<p>受苦的人，没有悲观的权利。——尼采</p>
</blockquote>
<h2 id="为什么需要程序语言" tabindex="-1"><a class="header-anchor" href="#为什么需要程序语言" aria-hidden="true">#</a> 为什么需要程序语言</h2>
...
<p>既然计算机程序的实际执行和语言无关，那么为什么要搞出来语言这种东西来？</p>
...
<blockquote>
<p>扩展：这种「比较直接的一一对应关系」怎么理解呢？例如，你甚至可以通过查表的方式，得出汇编语言 <code v-pre>MOV AX,66H</code> 对应机器码的十六进制 <code v-pre>B866</code>，也就是二进制 <code v-pre>1011100001100110</code>。</p>
<p>所以汇编 <code v-pre>MOV AX,66H</code> 与机器码 <code v-pre>1011100001100110</code> 相对应。这个结果也可以反向推导。</p>
<p>十六进制怎么转二进制？有了 Python 就不要去手工算了，执行 Python 代码 <code v-pre>bin(int('B866', 16))</code> 轻松得到结果。</p>
</blockquote>
...
<blockquote>
<p>扩展：计算机的世界里「抽象」这次词表示屏蔽掉内部纷繁复杂的细节，直接触达其核心功能，为外部建立起更高效更易用的使用入口和操作方法。</p>
<p>在之后的文章中「抽象」这个词会被频繁提及，因为它是计算机技术里非常重要的且具有指导意义的一个概念。</p>
</blockquote>
...
<h2 id="程序语言特性的层次" tabindex="-1"><a class="header-anchor" href="#程序语言特性的层次" aria-hidden="true">#</a> 程序语言特性的层次</h2>
<p>各种语言有如此多的不同之处，那它们的本质是什么呢？从本质上来看，这些程序语言都是机器码或者汇编语言的高级抽象，抽象出来的各种语言特性，可以以更高效易用的方式去表达计算机的指令。</p>
<h3 id="语言核心特性" tabindex="-1"><a class="header-anchor" href="#语言核心特性" aria-hidden="true">#</a> 语言核心特性</h3>
...
<h3 id="语言扩展特性" tabindex="-1"><a class="header-anchor" href="#语言扩展特性" aria-hidden="true">#</a> 语言扩展特性</h3>
...
<h3 id="语言周边知识和功能" tabindex="-1"><a class="header-anchor" href="#语言周边知识和功能" aria-hidden="true">#</a> 语言周边知识和功能</h3>
...
<h2 id="语言特性有层次之分-学习也有侧重点" tabindex="-1"><a class="header-anchor" href="#语言特性有层次之分-学习也有侧重点" aria-hidden="true">#</a> 语言特性有层次之分，学习也有侧重点</h2>
