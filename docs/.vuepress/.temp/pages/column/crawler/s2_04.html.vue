<template><div><h3 id="_1-http-与-https" tabindex="-1"><a class="header-anchor" href="#_1-http-与-https" aria-hidden="true">#</a> 1. HTTP 与 HTTPS</h3>
...
<p>4）http 的连接很简单，是无状态的；HTTPS 协议是由 <code v-pre>SSL+HTTP</code> 协议构建的可进行加密传输、身份认证的网络协议，比 http 协议安全。</p>
<h3 id="_2-请求头" tabindex="-1"><a class="header-anchor" href="#_2-请求头" aria-hidden="true">#</a> 2. 请求头</h3>
...
<h3 id="_3-cookies" tabindex="-1"><a class="header-anchor" href="#_3-cookies" aria-hidden="true">#</a> 3. Cookies</h3>
...
<h3 id="_4-html" tabindex="-1"><a class="header-anchor" href="#_4-html" aria-hidden="true">#</a> 4. HTML</h3>
<p>HTML就是编写前端页面使用的代码，一般用来搭建网站骨架，而渲染用css，实现网页交互使用Js。</p>
<h3 id="_5-json" tabindex="-1"><a class="header-anchor" href="#_5-json" aria-hidden="true">#</a> 5. json</h3>
...
<h3 id="_6-ajax" tabindex="-1"><a class="header-anchor" href="#_6-ajax" aria-hidden="true">#</a> 6. Ajax</h3>
