...
<h2 id="_1-小悦学-python-爬虫的过程" tabindex="-1"><a class="header-anchor" href="#_1-小悦学-python-爬虫的过程" aria-hidden="true">#</a> 1. 小悦学 Python 爬虫的过程</h2>
<p>从报名培训班，花了不下几万，最后得到的知识少之又少，收智商税的课程、割韭菜的课程让我深受其害。这个部分我之后有时间的话继续写。</p>
<h2 id="_2-爬虫是一个综合技艺" tabindex="-1"><a class="header-anchor" href="#_2-爬虫是一个综合技艺" aria-hidden="true">#</a> 2. 爬虫是一个综合技艺</h2>
...
<h2 id="_3-从最简单的-python-爬虫开始练习" tabindex="-1"><a class="header-anchor" href="#_3-从最简单的-python-爬虫开始练习" aria-hidden="true">#</a> 3. 从最简单的 Python 爬虫开始练习</h2>
