...
<h2 id="_1-大数据时代的爬虫岗位" tabindex="-1"><a class="header-anchor" href="#_1-大数据时代的爬虫岗位" aria-hidden="true">#</a> 1. 大数据时代的爬虫岗位</h2>
...
<h2 id="_2-网络爬虫概况" tabindex="-1"><a class="header-anchor" href="#_2-网络爬虫概况" aria-hidden="true">#</a> 2. 网络爬虫概况</h2>
<blockquote>
...
<h2 id="_3-搜索引擎时代的网络爬虫" tabindex="-1"><a class="header-anchor" href="#_3-搜索引擎时代的网络爬虫" aria-hidden="true">#</a> 3. 搜索引擎时代的网络爬虫</h2>
...
<h3 id="_3-1-使用-robots-txt" tabindex="-1"><a class="header-anchor" href="#_3-1-使用-robots-txt" aria-hidden="true">#</a> 3.1 使用 robots.txt</h3>
<p><img src="@source/column/crawler/s2_02.assets/1596515444616-4231b9eb-4cf1-4483-b315-838bd0c15904.png" alt="" loading="lazy"></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">from</span> urllib <span class="token keyword">import</span> robotparser
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-大数据时代的网络爬虫" tabindex="-1"><a class="header-anchor" href="#_4-大数据时代的网络爬虫" aria-hidden="true">#</a> 4. 大数据时代的网络爬虫</h2>
...
<h2 id="_5-网络爬虫的分类" tabindex="-1"><a class="header-anchor" href="#_5-网络爬虫的分类" aria-hidden="true">#</a> 5. 网络爬虫的分类</h2>
...
<blockquote>
<p>暗网（不可见网，隐藏网）是指那些存储在<a href="https://baike.baidu.com/item/%E7%BD%91%E7%BB%9C/1717974" target="_blank" rel="noopener noreferrer">网络<ExternalLinkIcon/></a>数据库里、但不能通过<a href="https://baike.baidu.com/item/%E8%B6%85%E9%93%BE%E6%8E%A5/97857" target="_blank" rel="noopener noreferrer">超链接<ExternalLinkIcon/></a>访问而需要通过动态网页技术访问的资源集合，不属于那些可以被标准搜索引擎索引的表面网络。
暗网是<a href="https://baike.baidu.com/item/%E6%B7%B1%E7%BD%91/22089976" target="_blank" rel="noopener noreferrer">深网<ExternalLinkIcon/></a>（Deep Web）的一个子集，属于深网的一小部分。
...
<hr>
<h3 id="_5-1-增量式爬虫-爬虫策略" tabindex="-1"><a class="header-anchor" href="#_5-1-增量式爬虫-爬虫策略" aria-hidden="true">#</a> 5.1 增量式爬虫 <strong>(爬虫策略)</strong></h3>
...
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token builtin">set</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>再详细一些就是：当我们把第一个数据例如上面的 <strong>hash 测试代码</strong> 第一个哈希：这是第一个评论，生成的伪随机数，存到我们的集合里面，第二个哈希由：这是第二个评论，生成的伪随机数，也存到我们所创建的集合中。当第三个哈希由：这是第一个评论，生成的伪随机数，存到集合中，集合将会将他阻挡在外。</p>
<p>当然，你还可以使用数据库，建立一个<strong>唯一索引</strong>。</p>
<p>扩展：还有 <strong>指纹、布隆过滤器等（相关数学）</strong></p>
<h3 id="_5-2-提取信息" tabindex="-1"><a class="header-anchor" href="#_5-2-提取信息" aria-hidden="true">#</a> 5.2 提取信息</h3>
<p><img src="@source/column/crawler/s2_02.assets/1596515444581-7d231bf6-d464-4a94-8f97-4b8b259e9e87.png" alt="" loading="lazy"></p>
<h3 id="_5-3-保存爬虫数据" tabindex="-1"><a class="header-anchor" href="#_5-3-保存爬虫数据" aria-hidden="true">#</a> 5.3 保存爬虫数据</h3>
...
<h2 id="_6-网络爬虫的自我约束" tabindex="-1"><a class="header-anchor" href="#_6-网络爬虫的自我约束" aria-hidden="true">#</a> 6. 网络爬虫的自我约束</h2>
...
<h2 id="_7-我们可以抓什么数据" tabindex="-1"><a class="header-anchor" href="#_7-我们可以抓什么数据" aria-hidden="true">#</a> 7. 我们可以抓什么数据</h2>
<p><img src="@source/column/crawler/s2_02.assets/1596515444515-8ab7ab7e-5e5a-4b3a-b01d-0b1c35d53e48.png" alt="" loading="lazy"></p>
<hr>
<h2 id="_8-识别网站技术" tabindex="-1"><a class="header-anchor" href="#_8-识别网站技术" aria-hidden="true">#</a> 8. 识别网站技术</h2>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>pip install builtwith
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>可以检测网站的一些常见技术</p>
...
<h2 id="_9-网络爬虫策略" tabindex="-1"><a class="header-anchor" href="#_9-网络爬虫策略" aria-hidden="true">#</a> 9. 网络爬虫策略：</h2>
<p><img src="@source/column/crawler/s2_02.assets/1596515444489-7fbd6313-9547-4399-a933-725beae1daf5.png" alt="" loading="lazy"></p>
<hr>
<h3 id="_9-1-广度优先算法" tabindex="-1"><a class="header-anchor" href="#_9-1-广度优先算法" aria-hidden="true">#</a> 9.1 广度优先算法</h3>
...
<hr>
<h3 id="_9-2-深度优先算法" tabindex="-1"><a class="header-anchor" href="#_9-2-深度优先算法" aria-hidden="true">#</a> 9.2 深度优先算法</h3>
...
<h3 id="_9-3-聚焦爬虫" tabindex="-1"><a class="header-anchor" href="#_9-3-聚焦爬虫" aria-hidden="true">#</a> 9.3 聚焦爬虫</h3>
...
<p>我们都会对 url 进行分析的。</p>
<hr>
<h2 id="_10-反爬虫案例" tabindex="-1"><a class="header-anchor" href="#_10-反爬虫案例" aria-hidden="true">#</a> 10. 反爬虫案例</h2>
...
<h3 id="_10-1-referer" tabindex="-1"><a class="header-anchor" href="#_10-1-referer" aria-hidden="true">#</a> 10.1 Referer</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/column/crawler/s2_02.assets/1596515444679-21479a5e-03e8-4023-adc3-54bdd15a2bb5.png" alt="" loading="lazy"></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> requests
url <span class="token operator">=</span> <span class="token string">'http://img3.laibafile.cn/p/m/310277586.jpg'</span>
...
<hr>
<h3 id="_10-2-用户访问频率限制-这个刚刚开始只需要了解即可-涉及异步" tabindex="-1"><a class="header-anchor" href="#_10-2-用户访问频率限制-这个刚刚开始只需要了解即可-涉及异步" aria-hidden="true">#</a> 10.2 用户访问频率限制（这个刚刚开始只需要了解即可-涉及异步）</h3>
...
<h3 id="_10-3-用户延迟访问插件" tabindex="-1"><a class="header-anchor" href="#_10-3-用户延迟访问插件" aria-hidden="true">#</a> 10.3 用户延迟访问插件</h3>
<p>该插件详细解析：<RouterLink to="/column/crawler/replenish02.html">还没用异步，爬取就速度太快？更智能的延迟插件</RouterLink></p>
...
<h3 id="_10-4-ajax-交互" tabindex="-1"><a class="header-anchor" href="#_10-4-ajax-交互" aria-hidden="true">#</a> 10.4 Ajax 交互</h3>
...
<h3 id="_10-5-网页数据加密" tabindex="-1"><a class="header-anchor" href="#_10-5-网页数据加密" aria-hidden="true">#</a> 10.5 网页数据加密</h3>
<p><img src="@source/column/crawler/s2_02.assets/1596515444703-4c170df6-52a3-4558-a49f-37c5db020a21.png" alt="" loading="lazy"></p>
<h3 id="_10-6-验证码" tabindex="-1"><a class="header-anchor" href="#_10-6-验证码" aria-hidden="true">#</a> 10.6 验证码</h3>
<p><img src="@source/column/crawler/s2_02.assets/1596515444716-9daab4d1-473b-4990-8c88-09715719c48d.png" alt="" loading="lazy"></p>
<h3 id="_10-7-字体反爬虫" tabindex="-1"><a class="header-anchor" href="#_10-7-字体反爬虫" aria-hidden="true">#</a> 10.7 字体反爬虫</h3>
...
<h3 id="_10-8-用户延迟访问插件使用演示" tabindex="-1"><a class="header-anchor" href="#_10-8-用户延迟访问插件使用演示" aria-hidden="true">#</a> 10.8 用户延迟访问插件使用演示</h3>
...
<span class="token keyword">for</span> url <span class="token keyword">in</span> urls<span class="token punctuation">:</span>
    ...
    <span class="token keyword">print</span><span class="token punctuation">(</span>html<span class="token punctuation">.</span>status_code<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>PS：这么理解即可</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">from</span> urllib <span class="token keyword">import</span> parse <span class="token comment"># 解析 URL</span>
