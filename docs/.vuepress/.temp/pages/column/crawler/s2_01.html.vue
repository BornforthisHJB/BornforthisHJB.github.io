<template><div><h2 id="_1-1-网络爬虫的定义" tabindex="-1"><a class="header-anchor" href="#_1-1-网络爬虫的定义" aria-hidden="true">#</a> 1.1 网络爬虫的定义</h2>
...
<h2 id="_1-2-网络爬虫的类型" tabindex="-1"><a class="header-anchor" href="#_1-2-网络爬虫的类型" aria-hidden="true">#</a> 1.2 网络爬虫的类型</h2>
...
<h2 id="_1-3-网络爬虫的原理" tabindex="-1"><a class="header-anchor" href="#_1-3-网络爬虫的原理" aria-hidden="true">#</a> 1.3 网络爬虫的原理</h2>
...
<h2 id="_1-4-网络爬虫的搜索策略" tabindex="-1"><a class="header-anchor" href="#_1-4-网络爬虫的搜索策略" aria-hidden="true">#</a> 1.4 网络爬虫的搜索策略</h2>
...
<h2 id="_1-5常见反爬虫技术与解决方案" tabindex="-1"><a class="header-anchor" href="#_1-5常见反爬虫技术与解决方案" aria-hidden="true">#</a> 1.5常见反爬虫技术与解决方案</h2>
<p>1）用户请求headers</p>
<p>从用户请求过来的 request headers 中查看是否存在 <code v-pre>User-Agent</code> ，如果不存在会在中间件中将请求过滤，不会返回正常 response。还有一些网站会通过请求头里边的 Referer 进行检测，一些资源网站的防止盗链技术就是通过这个来实现。对于这种反爬虫机制，我们只需要在 headers 中添加 <code v-pre>user-agent</code> 与 referer 就可以解决。</p>
<p>2）用户访问频率</p>
