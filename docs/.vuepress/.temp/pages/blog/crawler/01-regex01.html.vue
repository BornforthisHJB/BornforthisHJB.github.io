<template><div><h2 id="_1-需求" tabindex="-1"><a class="header-anchor" href="#_1-需求" aria-hidden="true">#</a> 1. 需求</h2>
<ol>
<li>抓取目标网站：<a href="https://bornforthis.cn/web_runing/crawler/regex/index.html" target="_blank" rel="noopener noreferrer">https://bornforthis.cn/web_runing/crawler/regex/index.html<ExternalLinkIcon/></a></li>
<li>技术限制：
<ol>
<li>requests</li>
<li>re</li>
...
<li>抓取目标音乐</li>
<li>存储制定路径：/data/music/</li>
</ol>
<h2 id="_2-导入所需库" tabindex="-1"><a class="header-anchor" href="#_2-导入所需库" aria-hidden="true">#</a> 2. 导入所需库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-编写代码" tabindex="-1"><a class="header-anchor" href="#_3-编写代码" aria-hidden="true">#</a> 3. 编写代码</h2>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> requests
<span class="token keyword">import</span> re
