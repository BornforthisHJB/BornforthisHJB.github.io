<template><div><h1 id="python入门-上" tabindex="-1"><a class="header-anchor" href="#python入门-上" aria-hidden="true">#</a> Python入门(上)</h1>
<ol>
<li>
<p><a href="#%E7%AE%80%E4%BB%8B">简介</a></p>
</li>
<li>
<p><a href="#%E5%8F%98%E9%87%8F%E3%80%81%E8%BF%90%E7%AE%97%E7%AC%A6%E4%B8%8E%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B">变量、运算符与数据类型</a><br>
<a href="#1.-%E6%B3%A8%E9%87%8A">1. 注释</a><br>
<a href="#2.-%E8%BF%90%E7%AE%97%E7%AC%A6">2. 运算符</a><br>
<a href="#3.-%E5%8F%98%E9%87%8F%E5%92%8C%E8%B5%8B%E5%80%BC">3. 变量和赋值</a><br>
<a href="#4.-%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B%E4%B8%8E%E8%BD%AC%E6%8D%A2">4. 数据类型与转换</a><br>
<a href="#5.-print()-%E5%87%BD%E6%95%B0">5. print()函数</a><br></p>
</li>
<li>
<p><a href="#%E4%BD%8D%E8%BF%90%E7%AE%97">位运算</a><br>
<a href="#1.-%E5%8E%9F%E7%A0%81%E3%80%81%E5%8F%8D%E7%A0%81%E5%92%8C%E8%A1%A5%E7%A0%81">1. 原码、反码和补码</a><br>
<a href="#2.-%E6%8C%89%E4%BD%8D%E8%BF%90%E7%AE%97">2. 按位运算</a><br>
<a href="#3.-%E5%88%A9%E7%94%A8%E4%BD%8D%E8%BF%90%E7%AE%97%E5%AE%9E%E7%8E%B0%E5%BF%AB%E9%80%9F%E8%AE%A1%E7%AE%97">3. 利用位运算实现快速计算</a><br>
<a href="#4.-%E5%88%A9%E7%94%A8%E4%BD%8D%E8%BF%90%E7%AE%97%E5%AE%9E%E7%8E%B0%E6%95%B4%E6%95%B0%E9%9B%86%E5%90%88">4. 利用位运算实现整数集合</a><br></p>
</li>
<li>
<p><a href="#%E6%9D%A1%E4%BB%B6%E8%AF%AD%E5%8F%A5">条件语句</a><br>
<a href="#1.-if-%E8%AF%AD%E5%8F%A5">1. if 语句</a><br>
<a href="#2.-if---else-%E8%AF%AD%E5%8F%A5">2. if - else 语句</a><br>
<a href="#3.-if---elif---else-%E8%AF%AD%E5%8F%A5">3. if - elif - else 语句</a><br>
<a href="#4.-assert-%E5%85%B3%E9%94%AE%E8%AF%8D">4. assert 关键词</a><br></p>
</li>
<li>
<p><a href="#%E5%BE%AA%E7%8E%AF%E8%AF%AD%E5%8F%A5">循环语句</a><br>
<a href="#1.-while-%E5%BE%AA%E7%8E%AF">1. while 循环</a><br>
<a href="#2.-while---else-%E5%BE%AA%E7%8E%AF">2. while - else 循环</a><br>
<a href="#3.-for-%E5%BE%AA%E7%8E%AF">3. for 循环</a><br>
<a href="#4.-for---else-%E5%BE%AA%E7%8E%AF">4. for - else 循环</a><br>
<a href="#5.-range()-%E5%87%BD%E6%95%B0">5. range() 函数</a><br>
<a href="#6.-enumerate()%E5%87%BD%E6%95%B0">6. enumerate()函数</a><br>
<a href="#7.-break-%E8%AF%AD%E5%8F%A5">7. break 语句</a><br>
<a href="#8.-continue-%E8%AF%AD%E5%8F%A5">8. continue 语句</a><br>
<a href="#9.-pass-%E8%AF%AD%E5%8F%A5">9. pass 语句</a><br>
<a href="#10.-%E6%8E%A8%E5%AF%BC%E5%BC%8F">10. 推导式</a><br></p>
</li>
<li>
<p><a href="#%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86">异常处理</a><br>
<a href="#1.-Python-%E6%A0%87%E5%87%86%E5%BC%82%E5%B8%B8%E6%80%BB%E7%BB%93">1. Python 标准异常总结</a><br>
<a href="#2.-Python%E6%A0%87%E5%87%86%E8%AD%A6%E5%91%8A%E6%80%BB%E7%BB%93">2. Python 标准警告总结</a><br>
<a href="#3.-try---except-%E8%AF%AD%E5%8F%A5">3. try - except 语句</a><br>
<a href="#4.-try---except---finally-%E8%AF%AD%E5%8F%A5">4. try - except - finally 语句</a><br>
<a href="#5.-try---except---else-%E8%AF%AD%E5%8F%A5">5. try - except - else 语句</a><br>
<a href="#6.-raise%E8%AF%AD%E5%8F%A5">6. raise语句</a><br></p>
</li>
</ol>
...
<h1 id="变量、运算符与数据类型" tabindex="-1"><a class="header-anchor" href="#变量、运算符与数据类型" aria-hidden="true">#</a> 变量、运算符与数据类型</h1>
<h2 id="_1-注释" tabindex="-1"><a class="header-anchor" href="#_1-注释" aria-hidden="true">#</a> 1. 注释</h2>
<ul>
<li>在 Python 中，<code v-pre>#</code> 表示注释，作用于整行。</li>
</ul>
<p>【例子】单行注释</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 这是一个注释</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"Hello world"</span><span class="token punctuation">)</span>

<span class="token comment"># Hello world</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><code v-pre>''' '''</code> 或者 <code v-pre>&quot;&quot;&quot; &quot;&quot;&quot;</code> 表示区间注释，在三引号之间的所有内容被注释</li>
</ul>
<p>【例子】多行注释</p>
...
<p>如：<code v-pre>print(&quot;hello 老表&quot;)</code></p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 写下你的答案</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-运算符" tabindex="-1"><a class="header-anchor" href="#_2-运算符" aria-hidden="true">#</a> 2. 运算符</h2>
...
<td style="text-align:center"><code v-pre>1 + 1</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>-</code></td>
<td style="text-align:center">减</td>
<td style="text-align:center"><code v-pre>2 - 1</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>*</code></td>
<td style="text-align:center">乘</td>
<td style="text-align:center"><code v-pre>3 * 4</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>/</code></td>
...
<tr>
<td style="text-align:center"><code v-pre>//</code></td>
<td style="text-align:center">整除（地板除）</td>
<td style="text-align:center"><code v-pre>3 // 4</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>%</code></td>
...
<td style="text-align:center"><code v-pre>2 ** 3</code></td>
</tr>
</tbody>
</table>
<p>【例子】</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="比较运算符" tabindex="-1"><a class="header-anchor" href="#比较运算符" aria-hidden="true">#</a> 比较运算符</h3>
<table>
<thead>
<tr>
<th style="text-align:center">操作符</th>
...
<td style="text-align:center"><code v-pre>2 &gt;= 4</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>&lt;</code></td>
...
<td style="text-align:center"><code v-pre>5 &lt;= 2</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>==</code></td>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="逻辑运算符" tabindex="-1"><a class="header-anchor" href="#逻辑运算符" aria-hidden="true">#</a> 逻辑运算符</h3>
<table>
<thead>
<tr>
<th style="text-align:center">操作符</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>and</code></td>
<td style="text-align:center">与</td>
<td style="text-align:center"><code v-pre>(3 &gt; 2) and (3 &lt; 5)</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>or</code></td>
<td style="text-align:center">或</td>
<td style="text-align:center"><code v-pre>(1 &gt; 3) or (9 &lt; 2)</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>not</code></td>
<td style="text-align:center">非</td>
<td style="text-align:center"><code v-pre>not (2 &gt; 1)</code></td>
</tr>
</tbody>
</table>
<p>【例子】</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="位运算符" tabindex="-1"><a class="header-anchor" href="#位运算符" aria-hidden="true">#</a> 位运算符</h3>
<table>
<thead>
<tr>
<th style="text-align:center">操作符</th>
...
<td style="text-align:center"><code v-pre>4 &amp; 5</code></td>
</tr>
<tr>
...
<td style="text-align:center"><code v-pre>4 &lt;&lt; 2</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>&gt;&gt;</code></td>
...
<p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>x<span class="token punctuation">,</span> y <span class="token operator">=</span> <span class="token number">4</span><span class="token punctuation">,</span> <span class="token number">5</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>有了这个三元操作符的条件表达式，你可以使用一条语句来完成以上的条件判断和赋值操作。</p>
<p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>x<span class="token punctuation">,</span> y <span class="token operator">=</span> <span class="token number">4</span><span class="token punctuation">,</span> <span class="token number">5</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>small<span class="token punctuation">)</span>  <span class="token comment"># 4</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其他运算符" tabindex="-1"><a class="header-anchor" href="#其他运算符" aria-hidden="true">#</a> 其他运算符</h3>
<table>
<thead>
<tr>
<th style="text-align:center">操作符</th>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>in</code></td>
<td style="text-align:center">存在</td>
<td style="text-align:center"><code v-pre>'A' in ['A', 'B', 'C']</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>not in</code></td>
<td style="text-align:center">不存在</td>
<td style="text-align:center"><code v-pre>'h' not in ['A', 'B', 'C']</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>is</code></td>
<td style="text-align:center">是</td>
<td style="text-align:center"><code v-pre>&quot;hello&quot; is &quot;hello&quot;</code></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>is not</code></td>
<td style="text-align:center">不是</td>
<td style="text-align:center"><code v-pre>&quot;hello&quot; is not &quot;hello&quot;</code></td>
</tr>
</tbody>
</table>
<p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>letters <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'A'</span><span class="token punctuation">,</span> <span class="token string">'B'</span><span class="token punctuation">,</span> <span class="token string">'C'</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】比较的两个变量均指向不可变类型。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> <span class="token string">"hello"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】比较的两个变量均指向可变类型。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">"hello"</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【我是测试题2】下面这段代码的运行结果是什么？</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 运行一下结果就出来了</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-变量和赋值" tabindex="-1"><a class="header-anchor" href="#_3-变量和赋值" aria-hidden="true">#</a> 3. 变量和赋值</h2>
<ul>
<li>在使用变量之前，需要对其先赋值。</li>
<li>变量名可以包括字母、数字、下划线、但变量名不能以数字开头。</li>
<li>Python 变量名是大小写敏感的，<code v-pre>foo != Foo</code>。</li>
</ul>
<p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>teacher <span class="token operator">=</span> <span class="token string">"老马的程序人生"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>first <span class="token operator">=</span> <span class="token number">2</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>myTeacher <span class="token operator">=</span> <span class="token string">"老马的程序人生"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【我是测试题3】运行下面一段代码看看结果是什么？</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token comment"># 运行一下就好啦</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-数据类型与转换" tabindex="-1"><a class="header-anchor" href="#_4-数据类型与转换" aria-hidden="true">#</a> 4. 数据类型与转换</h2>
<table>
<thead>
<tr>
...
<td style="text-align:center">整型 <code v-pre>&lt;class 'int'&gt;</code></td>
<td style="text-align:center"><code v-pre>-876, 10</code></td>
</tr>
<tr>
<td style="text-align:center">float</td>
<td style="text-align:center">浮点型<code v-pre>&lt;class 'float'&gt;</code></td>
<td style="text-align:center"><code v-pre>3.149, 11.11</code></td>
</tr>
<tr>
<td style="text-align:center">bool</td>
<td style="text-align:center">布尔型<code v-pre>&lt;class 'bool'&gt;</code></td>
<td style="text-align:center"><code v-pre>True, False</code></td>
</tr>
</tbody>
</table>
<h3 id="整型" tabindex="-1"><a class="header-anchor" href="#整型" aria-hidden="true">#</a> 整型</h3>
<p>【例子】通过 <code v-pre>print()</code> 可看出 <code v-pre>a</code> 的值，以及类 (class) 是<code v-pre>int</code>。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> <span class="token number">1031</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Python 里面万物皆对象（object），整型也不例外，只要是对象，就有相应的属性 （attributes） 和方法（methods）。</p>
<p>【例子】</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>b <span class="token operator">=</span> <span class="token builtin">dir</span><span class="token punctuation">(</span><span class="token builtin">int</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对它们有个大概印象就可以了，具体怎么用，需要哪些参数 （argument），还需要查文档。看个 <code v-pre>bit_length()</code> 的例子。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="浮点型" tabindex="-1"><a class="header-anchor" href="#浮点型" aria-hidden="true">#</a> 浮点型</h3>
<p>【例子】</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>有时候我们想保留浮点型的小数点后 <code v-pre>n</code> 位。可以用 <code v-pre>decimal</code> 包里的 <code v-pre>Decimal</code> 对象和 <code v-pre>getcontext()</code> 方法来实现。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token keyword">import</span> decimal
<span class="token keyword">from</span> decimal <span class="token keyword">import</span> Decimal
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Python 里面有很多用途广泛的包 (package)，用什么你就引进 (import) 什么。包也是对象，也可以用上面提到的 <code v-pre>dir(decimal)</code>  来看其属性和方法。</p>
<p>【例子】<code v-pre>getcontext()</code> 显示了 <code v-pre>Decimal</code> 对象的默认精度值是 28 位 (<code v-pre>prec=28</code>)。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> decimal<span class="token punctuation">.</span>getcontext<span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>b <span class="token operator">=</span> Decimal<span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span> <span class="token operator">/</span> Decimal<span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>b<span class="token punctuation">)</span>

<span class="token comment"># 0.3333333333333333333333333333</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】使 1/3 保留 4 位，用 <code v-pre>getcontext().prec</code> 来调整精度。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>decimal<span class="token punctuation">.</span>getcontext<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>prec <span class="token operator">=</span> <span class="token number">4</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="布尔型" tabindex="-1"><a class="header-anchor" href="#布尔型" aria-hidden="true">#</a> 布尔型</h3>
<p>布尔 (boolean) 型变量只能取两个值，<code v-pre>True</code> 和 <code v-pre>False</code>。当把布尔型变量用在数字运算中，用 <code v-pre>1</code> 和 <code v-pre>0</code> 代表 <code v-pre>True</code> 和 <code v-pre>False</code>。</p>
<p>【例子】</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了直接给变量赋值 <code v-pre>True</code> 和 <code v-pre>False</code>，还可以用 <code v-pre>bool(X)</code> 来创建变量，其中 <code v-pre>X</code> 可以是</p>
<ul>
<li>基本类型：整型、浮点型、布尔型</li>
<li>容器类型：字符串、元组、列表、字典和集合</li>
</ul>
<p>【例子】<code v-pre>bool</code> 作用在基本类型变量：<code v-pre>X</code> 只要不是整型 <code v-pre>0</code>、浮点型 <code v-pre>0.0</code>，<code v-pre>bool(X)</code> 就是 <code v-pre>True</code>，其余就是 <code v-pre>False</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】<code v-pre>bool</code> 作用在容器类型变量：<code v-pre>X</code> 只要不是空的变量，<code v-pre>bool(X)</code> 就是 <code v-pre>True</code>，其余就是 <code v-pre>False</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>确定 <code v-pre>bool(X)</code> 的值是 <code v-pre>True</code> 还是 <code v-pre>False</code>，就看 <code v-pre>X</code> 是不是空，空的话就是 <code v-pre>False</code>，不空的话就是 <code v-pre>True</code>。</p>
<ul>
<li>对于数值变量，<code v-pre>0</code>, <code v-pre>0.0</code> 都可认为是空的。</li>
<li>对于容器变量，里面没元素就是空的。</li>
</ul>
<p><b>获取类型信息</b></p>
<ul>
<li>获取类型信息 <code v-pre>type(object)</code></li>
</ul>
<p>【例子】</p>
...
<ul>
<li><code v-pre>type()</code> 不会认为子类是一种父类类型，不考虑继承关系。</li>
<li><code v-pre>isinstance()</code> 会认为子类是一种父类类型，考虑继承关系。</li>
</ul>
<p>如果要判断两个类型是否相同推荐使用 <code v-pre>isinstance()</code>。</p>
<p><strong>类型转换</strong></p>
<ul>
<li>转换为整型 <code v-pre>int(x, base=10)</code></li>
<li>转换为字符串 <code v-pre>str(object='')</code></li>
<li>转换为浮点型 <code v-pre>float(x)</code></li>
</ul>
<p>【例子】</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-print-函数" tabindex="-1"><a class="header-anchor" href="#_5-print-函数" aria-hidden="true">#</a> 5. print() 函数</h2>
...
<li>将对象以字符串表示的方式格式化输出到流文件对象 file 里。其中所有非关键字参数都按 <code v-pre>str()</code> 方式进行转换为字符串输出；</li>
<li>关键字参数 <code v-pre>sep</code> 是实现分隔符，比如多个参数输出时想要输出中间的分隔字符；</li>
<li>关键字参数 <code v-pre>end</code> 是输出结束时的字符，默认是换行符<code v-pre>\n</code>；</li>
<li>关键字参数 <code v-pre>file</code> 是定义流输出的文件，可以是标准的系统输出 <code v-pre>sys.stdout</code> ，也可以重定义为别的文件；</li>
<li>关键字参数 <code v-pre>flush</code> 是立即把内容输出到流文件，不作缓存。</li>
</ul>
<p>【例子】没有参数时，每次输出后都会换行。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>shoplist <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'apple'</span><span class="token punctuation">,</span> <span class="token string">'mango'</span><span class="token punctuation">,</span> <span class="token string">'carrot'</span><span class="token punctuation">,</span> <span class="token string">'banana'</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】每次输出结束都用<code v-pre>end</code>设置的参数<code v-pre>&amp;</code>结尾，并没有默认换行。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>shoplist <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'apple'</span><span class="token punctuation">,</span> <span class="token string">'mango'</span><span class="token punctuation">,</span> <span class="token string">'carrot'</span><span class="token punctuation">,</span> <span class="token string">'banana'</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例子】<code v-pre>item</code>值与<code v-pre>'another string'</code>两个值之间用<code v-pre>sep</code>设置的参数<code v-pre>&amp;</code>分割。由于<code v-pre>end</code>参数没有设置，因此默认是输出解释后换行，即<code v-pre>end</code>参数的默认值为<code v-pre>\n</code>。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code>shoplist <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'apple'</span><span class="token punctuation">,</span> <span class="token string">'mango'</span><span class="token punctuation">,</span> <span class="token string">'carrot'</span><span class="token punctuation">,</span> <span class="token string">'banana'</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="位运算" tabindex="-1"><a class="header-anchor" href="#位运算" aria-hidden="true">#</a> 位运算</h1>
<h2 id="_1-原码、反码和补码" tabindex="-1"><a class="header-anchor" href="#_1-原码、反码和补码" aria-hidden="true">#</a> 1. 原码、反码和补码</h2>
<p>二进制有三种不同的表示形式：原码、反码和补码，<u>计算机内部使用补码来表示</u>。</p>
<p><strong>原码</strong>：就是其二进制表示（注意，有一位符号位）。</p>
<div class="language-python ext-py line-numbers-mode"><pre v-pre class="language-python"><code><span class="token number">00</span> <span class="token number">00</span> <span class="token number">00</span> <span class="token number">11</span> <span class="token operator">-</span><span class="token operator">></span> <span class="token number">3</span>
