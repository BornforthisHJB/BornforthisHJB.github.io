<template><div><h2 id="_1-为什么需要学习编程" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要学习编程" aria-hidden="true">#</a> 1. 为什么需要学习编程？</h2>
<p>如今，学习编程的人分为两类，一类是程序员，另一类是期望成为程序员的人。</p>
<p>编程这个事儿，在大多数人眼中还是一种特定领域的、专门的技能，认为学的人都是需要以此谋生的。</p>
<p>其实，我曾经跟一个作为一个“码龄”超过20年的老程序员聊过，他是这样认为的：在不久的将来（也许三五年，也许十来年之后），编程将<strong>从一个职业技能逐步蜕变为职场通用技能</strong>。</p>
...
<p>不久的将来，职业写代码的人，将越来越少。取而代之的，编程将是每个职业人的必备技能，拥有更多技能的人，就更有拿到好 offer，升职加薪的机会。</p>
...
<h2 id="_2-那么编程的核心是什么" tabindex="-1"><a class="header-anchor" href="#_2-那么编程的核心是什么" aria-hidden="true">#</a> 2. 那么编程的核心是什么？</h2>
<p>从语言特征（词汇、语法等）的角度来讲，<strong>最复杂的编程语言远比最简单的自然语言简单得多</strong> 。</p>
...
<p>从纯粹软件的角度讲，甚至可以说：<strong>算法 + 数据 == 计算机程序</strong> 。</p>
<p>受过计算机科班教育的人一定上过一门课：数据结构，这门课是计算机科学的基础，它的核心内容就是各式各样的算法，它们是几代计算机科学家从解决现实问题中提取出的套路——这些才是编程的核心。</p>
<h2 id="_3-经得起时间考验的通识技能" tabindex="-1"><a class="header-anchor" href="#_3-经得起时间考验的通识技能" aria-hidden="true">#</a> 3. 经得起时间考验的通识技能</h2>
...
<h2 id="_4-本专栏讲了些什么" tabindex="-1"><a class="header-anchor" href="#_4-本专栏讲了些什么" aria-hidden="true">#</a> 4. 本专栏讲了些什么？</h2>
<p>本专栏就带领大家，<strong>由编程学算法，以算法促编程</strong> 。从零开始，同步学习两方面内容：</p>
<ul>
...
<li>快速排序</li>
<li>编程和 bug 总是难舍难分，为了系统性减少 bug ，就要讲软件工程。</li>
<li>讲算法就离不了策略，分治策略是快速排序的基础，而引申自数学的递归则是分治策略的实现方法……</li>
</ul>
<p>5）结课前会给出本专栏之后继续学习算法和编程的方向与方法。</p>
<p>祝大家学习顺利，有所提高！接下来让我们一起，迈入编程的大门！</p>
<h2 id="_5-分享交流" tabindex="-1"><a class="header-anchor" href="#_5-分享交流" aria-hidden="true">#</a> 5. 分享交流</h2>
<p>我们为本专栏付费读者创建了微信交流群，以方便更有针对性地讨论专栏相关问题。入群方式请到第 7 篇末尾添加小助手的微信号，回复关键字入群。</p>
<p>阅读文章过程中有任何疑问随时可以跟其他小伙伴讨论，或者直接向作者提问（作者看到后抽空回复）。你的分享不仅帮助他人，更会提升自己。</p>
<p>关注公众号：AI悦创，更多优质技术文章等你哦！</p>
