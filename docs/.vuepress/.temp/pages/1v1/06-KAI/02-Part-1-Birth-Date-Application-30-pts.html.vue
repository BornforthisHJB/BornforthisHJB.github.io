<template><div><h2 id="part-1-birth-date-application-30-pts-use-mod-and-division-to-separate-digits-for-birthday-date-birthdays-java" tabindex="-1"><a class="header-anchor" href="#part-1-birth-date-application-30-pts-use-mod-and-division-to-separate-digits-for-birthday-date-birthdays-java" aria-hidden="true">#</a> Part 1: Birth Date Application: (30 pts)Use MOD % and / division to separate digits for Birthday date Birthdays.java</h2>
<p>Ask for the user to enter a two people’s birthday as an 8 digit-number! The user should enter the birthday for each person in an 8-digit format (&quot;YYYYMMDD&quot;). Then your program should compare the two birthday dates to determine which person is older, or if they have the same age.</p>
<blockquote>
<p>要求用户输入两个人的生日作为一个 8 位数的数字!</p>
<p>用户应该以 8 位数字格式 <code v-pre>(“YYYYMMDD”)</code> 输入每个人的生日。然后你的程序应该比较两个生日日期，以确定谁更年长，或者他们是否有相同的年龄。</p>
</blockquote>
<p>For example, President’s Obama's birthday is Aug 4,1961. So, it should be entered as 19610804 (YYYYMMDD). We can assume that the user enters good data with 8 digits for each birthday so you do not have to do any data validation.</p>
<blockquote>
<p>例如，奥巴马总统的生日是1961年8月4日。因此，它应该输入为19610804 (YYYYMMDD)。我们可以假设用户为每个生日输入 8 位数字，这样您就不必进行任何数据验证。</p>
</blockquote>
<ul>
<li>This program should separate each 8-digit-number into three separate numbers to represent the day, month, and the year, in that order. <strong>Only use the mathematical operators to separate the digits (will cover this during class).</strong></li>
</ul>
<blockquote>
<p>这个程序应该将每个8位数字按顺序分成三个单独的数字，分别表示日、月和年。<strong>只使用数学运算符来分隔数字</strong> (将在课堂上讨论)。</p>
</blockquote>
<p>Thus, in our example the program would assign 4 to a first variable from the right, let's say day, then assign 8 to a second variable, let's say month and 1961 to the number variable, let's say year. (Do not worry about leading zeroes for days and months.)</p>
<blockquote>
<p>因此，在我们的例子中，程序会将 4 赋值给右边的第一个变量，比如 day，然后将 8 赋值给第二个变量，比如 month，将 1961 赋值给 number 变量，比如 year。(不用担心天数和月份的前导零。)</p>
</blockquote>
<p>Next the program should print out the date of birth written in the following standard format MM/DD/YYYY for each person. So, the output for Obama’s date of birth should be as follow: 8/4/1961</p>
<blockquote>
<p>接下来，程序将为每个人打印出以以下标准格式写的出生日期 MM/DD/YYYY。因此，奥巴马出生日期的输出应该如下: 8/4/1961</p>
</blockquote>
<p>Also, your program should be able to print which person is older or the other possibility that they are the same age. You should use control structure allowing program to make decision (smart). So, result should be decided by program and not you.</p>
<blockquote>
<p>另外，你的程序应该能够打印出哪个人更老，或者他们是相同年龄的其他可能性。你应该使用允许程序做出决策(智能)的控制结构。所以，结果应该由程序决定，而不是由你决定。</p>
</blockquote>
<h2 id="example-comparing-obama-s-to-beyonce-birthday" tabindex="-1"><a class="header-anchor" href="#example-comparing-obama-s-to-beyonce-birthday" aria-hidden="true">#</a> Example (Comparing Obama’s to Beyoncé Birthday):</h2>
<p>Enter the birthday in 8-digit format for person's # 1: (YYYYMMDD): 19610804</p>
<p>Enter the birthday in 8-digit format for person's # 2, (YYYYMMDD): 19810904</p>
<p><strong>For this example, the following result will be printed:</strong></p>
<p>Enter name for person #1: Obama</p>
<p>Enter name for person #2: Beyoncé</p>
<p>Obama’s date of birth is: 8/4/1961</p>
<p>Beyoncé’s date of birth is: 9/4/1981</p>
<p>Obama is Older than Beyoncé!</p>
<h2 id="grading-criteria" tabindex="-1"><a class="header-anchor" href="#grading-criteria" aria-hidden="true">#</a> Grading Criteria:</h2>
<p>A. Program Execution (90%)</p>
<p>Meeting all of the require</p>
<h2 id="答案" tabindex="-1"><a class="header-anchor" href="#答案" aria-hidden="true">#</a> 答案</h2>
<h3 id="_1-整数分割" tabindex="-1"><a class="header-anchor" href="#_1-整数分割" aria-hidden="true">#</a> 1. 整数分割</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HW</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HW</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-编写成对象" tabindex="-1"><a class="header-anchor" href="#_3-编写成对象" aria-hidden="true">#</a> 3. 编写成对象</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HW</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
