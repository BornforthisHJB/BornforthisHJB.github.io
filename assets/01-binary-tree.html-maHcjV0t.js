import{_ as e}from"./gzh-X2g0OvFa.js";import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c,a as n,b as s,d as i,e as l}from"./app-4CaQC49p.js";const u={},d=l(`<h2 id="_1-初识二叉树" tabindex="-1"><a class="header-anchor" href="#_1-初识二叉树"><span>1. 初识二叉树</span></a></h2><p>你好，我是悦创。</p><p><strong>二叉树</strong>是一个有限元素的集合，这个集合要么是空集，要么是由一个称为根的元素以及两个不相交的、分别称为左子树和右子树的二叉树组成。</p><p>让我们使用文本来表示一个二叉树。</p><p>考虑这样一个简单的二叉树：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>    1
   / \\
  2   3
 / \\ / \\
4  5 6  7
