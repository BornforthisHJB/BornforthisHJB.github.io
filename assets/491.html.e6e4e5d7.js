...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),j={href:"https://www.aiyc.top/1946.html",target:"_blank",rel:"noopener noreferrer"},G=a(`<div class="language-nvm line-numbers-mode" data-ext="nvm"><pre class="language-nvm"><code>nvm list
nvm use vxxxx
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23),F={href:"http://localhost:4000",target:"_blank",rel:"noopener noreferrer"},H=a('<p><img src="'+p+`" alt="在这里插入图片描述" loading="lazy"></p><p>你会发现，在你编辑的 gitbook项目的目录中会多一个 <code>_book</code> 目录，而这个目录中就是生成的本地预览的静态网站内容。</p><h4 id="_2-使用-gitbook-build-参数" tabindex="-1"><a class="header-anchor" href="#_2-使用-gitbook-build-参数" aria-hidden="true">#</a> 2. 使用 gitbook build 参数</h4><p>与直接预览生成的静态网站不一样的时，使用这个命令，你可以将内容输出到你想要的目录。</p><blockquote><p>Ps：<code>gitbook build ./{book_name} --output=./{outputFolde}</code><code>gitbook build [当前路径] [输出路径]</code><code>gitbook build ./ doc # 默认打包输出到当前路径下面的 doc 文件夹中</code></p></blockquote><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>$ gitbook build --output=/tmp/gitbook
Starting build ...
Successfuly built !
$ ls /tmp/gitbook/
