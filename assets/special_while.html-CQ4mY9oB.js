import{_ as e}from"./gzh-DnOBNg6W.js";import{_ as p}from"./zsxq-BcdwOI-_.js";import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as l,c as o,a as n,b as s,d as c,e as u}from"./app-DSrcuQ5x.js";const r={},d=u(`<h2 id="_1-寻找可以被整除的程序" tabindex="-1"><a class="header-anchor" href="#_1-寻找可以被整除的程序"><span>1. 寻找可以被整除的程序</span></a></h2><h3 id="_1-1-question-输出-100-200-之间可以把-3-整除的数据" tabindex="-1"><a class="header-anchor" href="#_1-1-question-输出-100-200-之间可以把-3-整除的数据"><span>1.1 Question：输出 100～200 之间可以把 3 整除的数据</span></a></h3><p>方法一：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>divided <span class="token operator">=</span> <span class="token number">100</span>
...
<span class="token keyword">while</span> divided <span class="token operator">&lt;=</span> <span class="token number">200</span> <span class="token keyword">and</span> index <span class="token operator">&lt;</span> <span class="token number">10</span><span class="token punctuation">:</span>
    ...
    index <span class="token operator">+=</span> <span class="token number">1</span>
    divided <span class="token operator">+=</span> <span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出效果：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token number">102</span>可以整除<span class="token number">3</span>。商为<span class="token number">34</span>
<span class="token number">105</span>可以整除<span class="token number">3</span>。商为<span class="token number">35</span>
<span class="token number">108</span>可以整除<span class="token number">3</span>。商为<span class="token number">36</span>
<span class="token number">111</span>可以整除<span class="token number">3</span>。商为<span class="token number">37</span>
<span class="token number">114</span>可以整除<span class="token number">3</span>。商为<span class="token number">38</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container info"><p class="hint-container-title">悦创金句</p><p>程序员就是连接人与机器之间的桥梁——AI悦创</p></div><p>欢迎关注我公众号：AI悦创，有更多更好玩的等你发现！</p><details class="hint-container details"><summary>公众号：AI悦创【二维码】</summary><figure><img src="`+e+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></details>',21),k={class:"hint-container info"},m=n("p",{class:"hint-container-title"},"AI悦创·编程一对一",-1),b=n("p",null,"AI悦创·推出辅导班啦，包括「Python 语言辅导班、C++ 辅导班、java 辅导班、算法/数据结构辅导班、少儿编程、pygame 游戏开发」，全部都是一对一教学：一对一辅导 + 一对一答疑 + 布置作业 + 项目实践等。当然，还有线下线上摄影课程、Photoshop、Premiere 一对一教学、QQ、微信在线，随时响应！微信：Jiabcdefh",-1),v=n("p",null,"C++ 信息奥赛题解，长期更新！长期招收一对一中小学信息奥赛集训，莆田、厦门地区有机会线下上门，其他地区线上。微信：Jiabcdefh",-1),x={href:"http://wpa.qq.com/msgrd?v=3&uin=1432803776&site=qq&menu=yes",target:"_blank",rel:"noopener noreferrer"},h=n("p",null,"方法二：微信：Jiabcdefh",-1),g=n("figure",null,[n("img",{src:p,alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1);function y(_,f){const a=i("ExternalLinkIcon");return l(),o("div",null,[d,n("div",k,[m,b,v,n("p",null,[s("方法一："),n("a",x,[s("QQ"),c(a)])]),h]),g])}const I=t(r,[["render",y],["__file","special_while.html.vue"]]),A=JSON.parse('{"path":"/Python/basequestion/special_while.html","title":"04-while 专项练习","lang":"zh-CN","frontmatter":{"title":"04-while 专项练习","date":"2022-08-08T07:42:13.000Z","author":"AI悦创","isOriginal":true,"category":"Python 私教练习题【基础】","tag":["Python 基础练习题"],"icon":"python","sticky":false,"star":false,"article":true,"timeline":true,"image":false,"navbar":true,"sidebarIcon":true,"headerDepth":5,"comment":true,"lastUpdated":true,"editLink":true,"prev":"special_for.md","next":"special_while.md","backToTop":true,"toc":true,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"1. 寻找可以被整除的程序","slug":"_1-寻找可以被整除的程序","link":"#_1-寻找可以被整除的程序","children":[{"level":3,"title":"1.1 Question：输出 100～200 之间可以把 3 整除的数据","slug":"_1-1-question-输出-100-200-之间可以把-3-整除的数据","link":"#_1-1-question-输出-100-200-之间可以把-3-整除的数据","children":[]},{"level":3,"title":"1.2 Question：输出前十个可以整除 3 的数据","slug":"_1-2-question-输出前十个可以整除-3-的数据","link":"#_1-2-question-输出前十个可以整除-3-的数据","children":[]}]},{"level":2,"title":"2.编写用户登陆程序","slug":"_2-编写用户登陆程序","link":"#_2-编写用户登陆程序","children":[{"level":3,"title":"2.1 用户数据","slug":"_2-1-用户数据","link":"#_2-1-用户数据","children":[]},{"level":3,"title":"2.2 答案","slug":"_2-2-答案","link":"#_2-2-答案","children":[]}]}],"git":{"createdTime":1704501196000,"updatedTime":1704501196000,"contributors":[{"name":"AndersonHJB","email":"cleland1432803776@icloud.com","commits":1}]},"readingTime":{"minutes":3.89,"words":1167},"filePathRelative":"Python/basequestion/special_while.md","localizedDate":"2022年8月8日","copyright":{"author":"AI悦创"}}');export{I as comp,A as data};
